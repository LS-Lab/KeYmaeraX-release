...
case class TermArg(override val name: String, override val allowsFresh: List[String] = Nil)
    extends TermArgBase(name, allowsFresh) {}

case class VariableArg(override val name: String, override val allowsFresh: List[String] = Nil)
    extends TermArgBase(name, allowsFresh) {
  override val sort = "variable"
}

case class NumberArg(override val name: String, override val allowsFresh: List[String] = Nil)
    extends TermArgBase(name, allowsFresh) {
