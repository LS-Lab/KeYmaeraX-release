  ...
  def impl(c: whitebox.Context)(annottees: c.Expr[Any]*): c.Expr[Any] = {
    ...
    def typeName(ai: ArgInfo): Tree = {
      ai match {
        ...
        case _: VariableArg => tq"org.keymaerax.core.Variable"
        case _: TermArg => tq"org.keymaerax.core.Term"
        case _: SubstitutionArg => tq"org.keymaerax.core.SubstitutionPair"
        case _: ExpressionArg => tq"org.keymaerax.core.Expression"
        case _: PosInExprArg => tq"org.keymaerax.infrastruct.PosInExpr"
