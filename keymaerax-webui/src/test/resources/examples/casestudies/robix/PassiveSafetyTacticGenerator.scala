...
class PassiveSafetyTacticGenerator extends (() => Tactic) {
  ...
  def apply() = {
    ...
    val invariant =
      """   v >= 0
                    ...
                    |             & (y-yo <= 0 -> yo-y > v^2 / (2*B) + V()*(v/B))))""".stripMargin.
  ...
  def plantT(a: FuncOf, xo: Variable, yo: Variable) = ls(boxSeqT) & ls(boxAssignT) & ls(
    ...
    (cutShowLbl,
      debugT("Show t_2>=0") &
      la(hideT, "v_0=0|(x_0-xo_0>=0->x_0-xo_0>v_0^2/(2*B)+V()*(v_0/B))&(x_0-xo_0<=0->xo_0-x_0>v_0^2/(2*B)+V()*(v_0/B))|(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))",
        "dxo()^2+dyo()^2<=V()^2", "dx^2+dy^2=1") &
      (ls(diffInvariantT) |
    ...
    (cutUseLbl, debugT("Use t_2>=0") &
      ...
      (cutShowLbl, debugT("Show dx^2+dy^2=1") &
        la(hideT,
          "v_0=0|(x_0-xo_0>=0->x_0-xo_0>v_0^2/(2*B)+V()*(v_0/B))&(x_0-xo_0<=0->xo_0-x_0>v_0^2/(2*B)+V()*(v_0/B))|(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))", "dxo()^2+dyo()^2<=V()^2") &
        ls(
      ...
      (cutUseLbl, debugT("Use dx^2+dy^2=1") &
        ...
        (cutUseLbl, debugT("Use v=v0+a*t") & discreteGhostT(Some(Variable("x0"
          ...
          (cutShowLbl, debugT("Show ... <= x - x0 <= ...") & la(hideT, /*"r_0()!=0", "dx^2+dy^2=1",*/
            "v_0=0|(x_0-xo_0>=0->x_0-xo_0>v_0^2/(2*B)+V()*(v_0/B))&(x_0-xo_0<=0->xo_0-x_0>v_0^2/(2*B)+V()*(v_0/B))|(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))") & ls(
            diffInvariantT)),
          (cutUseLbl, debugT(
            ...
            (cutShowLbl, debugT("Show ... <= y - y0 <= ...") & la(hideT, /*"r_0()!=0", "dx^2+dy^2=1",*/
              "v_0=0|(x_0-xo_0>=0->x_0-xo_0>v_0^2/(2*B)+V()*(v_0/B))&(x_0-xo_0<=0->xo_0-x_0>v_0^2/(2*B)+V()*(v_0/B))|(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))") & ls(diffInvariantT)),
            (
  ...
  def hideAndEqT(xo:
    ...
    la(hideT, "r!=0", "v>=0","dx^2+dy^2=1",
      "dxo()^2+dyo()^2<=V()^2", "t_2=0", "v0_1()=v_0",
      "x0_1()=x_0",
  ...
  val brakeFinishT = onBranch(
    (
      ...
      la(hideT, "ep()>0", "V()>=0", "A>=0", "v_0>=0", "t_3<=ep()", "x_1-x_0<=t_3*(v_1--B/2*t_3)",
        ...
        ls(hideT,
          "(y_1-yo_1>=0->y_1-yo_1>v_1^2/(2*B)+V()*(v_1/B))&(y_1-yo_1<=0->yo_1-y_1>v_1^2/(2*B)+V()*(v_1/B))",
  ...
  val stoppedFinishT = onBranch(
    (
      ...
      la(hideT, "ep()>0", "V()>=0", "B>0", "A>=0", "v_0>=0", "w_2=0", "t_3<=ep()", "v_1>=0",
        ...
        "y_1-y_0<=t_3*(v_1-a_1()/2*t_3)", "-t_3*V()<=xo_1-xo_0",
        "xo_1-xo_0<=t_3*V()", "-t_3*V()<=yo_1-yo_0", "yo_1-yo_0<=t_3*V()") &
        ls(hideT,
          "(y_1-yo_1>=0->y_1-yo_1>v_1^2/(2*B)+V()*(v_1/B))&(y_1-yo_1<=0->yo_1-y_1>v_1^2/(2*B)+V()*(v_1/B))",
          "(x_1-xo_1>=0->x_1-xo_1>v_1^2/(2*B)+V()*(v_1/B))&(x_1-xo_1<=0->xo_1-x_1>v_1^2/(2*B)+V()*(v_1/B))") &
    ...
    ("Know x",
      la(hideT, "ep()>0",
        "V()>=0", "B>0", "A>=0",
        "(x_0-xo_0>=0->x_0-xo_0>v_0^2/(2*B)+V()*(v_0/B))&(x_0-xo_0<=0->xo_0-x_0>v_0^2/(2*B)+V()*(v_0/B))",
        "v_0>=0", "w_2=0",
    ...
    (
      "Know y",
      la(hideT, "ep()>0", "V()>=0",
        "B>0", "A>=0", "(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))",
        "v_0>=0", "w_2=0", "t_3<=ep()", "v_1>=0", "-t_3*(v_1-a_1()/2*t_3)<=x_1-x_0",
  ...
  val accelerateFinishBaseT = la(OrLeftT) && (
    la(hideT,
      "-t_3*(v_1-a()/2*t_3)<=y_1-y_0", "y_1-y_0<=t_3*(v_1-a()/2*t_3)", "-t_3*V()<=yo_2-yo_1",
      "yo_2-yo_1<=t_3*V()") &
      ls(
        hideT,
        "(y_1-yo_2>=0->y_1-yo_2>v_1^2/(2*B)+V()*(v_1/B))&(y_1-yo_2<=0->yo_2-y_1>v_1^2/(2*B)+V()*(v_1/B))") & la(AndLeftT) &
      ls(AndRightT) && (
      ls(ImplyRightT) & debugT("Foo 1-1") & ImplyLeftT(AntePosition(15))/*x_0-xo_1>=0->x_0-xo_1>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V()))*/ && (
        ...
        ImplyLeftT(AntePosition(15)) && (
          ...
          /* contradiction in antecedent */ debugT("Foo 1-1a") & la(hideT, "-t_3*(v_1-a()/2*t_3)<=x_1-x_0", "xo_2-xo_1<=t_3*V()", "-B<=a()") & ls(hideT,
          "x_1-xo_2>v_1^2/(2*B)+V()*(v_1/B)", "x_0-xo_1>=0") & QE
          ),
        ImplyLeftT(AntePosition(15)) && (
          debugT("Foo 1-1b") & la(hideT,
            "x_1-x_0<=t_3*(v_1-a()/2*t_3)", "-t_3*V()<=xo_2-xo_1",
      ...
      ls(ImplyRightT
        ...
        (15)) /* x_0-xo_1>=0->x_0-xo_1>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V())) */ && (
        /*"x_0-xo_1<=0->xo_1-x_0>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V()))*/
        ImplyLeftT(AntePosition(15)) && (
          /* tautology x-xo >= 0 | x-xo <= 0 in succedent */ QE,
          debugT("Foo 1-2a") & la(hideT, "-t_3*(v_1-a()/2*t_3)<=x_1-x_0", "xo_2-xo_1<=t_3*V()", "-B<=a()") & ls(hideT
            , "x_0-xo_1>=0") & QE
          ),
        ImplyLeftT(AntePosition(15)) && (
          /* contradiction in antecedent */
          debugT("Foo 1-2b") &
            la(hideT, "x_1-x_0<=t_3*(v_1-a()/2*t_3)", "-t_3*V()<=xo_2-xo_1", "-B<=a()") & ls(hideT, "xo_2-x_1>v_1^2/(2*B)+V()*(v_1/B)") & QE,
          /* contradiction in antecedent */ QE
          )
        )
      ),
    debugT("Foo 2") &
      la(hideT,
        ...
        "-t_3*V()<=xo_2-xo_1", "xo_2-xo_1<=t_3*V()") &
      ...
      ls(
        ...
        ImplyLeftT(AntePosition(15)) /* y_0-yo_1>=0->y_0-yo_1>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V())) */ && (
        ...
        ImplyLeftT(AntePosition(15)) && (
          ...
          "-t_3*(v_1-a()/2*t_3)<=y_1-y_0", "yo_2-yo_1<=t_3*V()", "-B<=a()") & ls(hideT,"y_1-yo_2>v_1^2/(2*B)+V()*(v_1/B)", "y_0-yo_1>=0") & QE
          ),
        ImplyLeftT(
          AntePosition(15)) && (
          debugT("Foo 2-1b") & la(hideT, "y_1-y_0<=t_3*(v_1-a()/2*t_3)", "-t_3*V()<=yo_2-yo_1", "-B<=a()") & ls(
            hideT, "y_0-yo_1<=0") & QE,
          /* contradiction in antecedent */ QE
          )
        ),
      ls(ImplyRightT) & debugT("Foo 2-2") & ImplyLeftT(AntePosition(15))
        /* y_0-yo_1>=0->y_0-yo_1>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V())) */ && (

        // y_0-yo_1<=0->yo_1-y_0>v_0^2/(2*B)+V()*v_0/B+(A/B+1)*(A/2*ep()^2+ep()*(v_0+V()))
        ImplyLeftT(AntePosition(15)) && (
          /* tautology in succedent */ QE,
          debugT(
            "Foo 2-2a") & la(hideT, "-t_3*(v_1-a()/2*t_3)<=y_1-y_0", "yo_2-yo_1<=t_3*V()", "-B<=a()") & ls(hideT, "y_0-yo_1>=0") & QE
          ),
        ImplyLeftT(AntePosition(15)
        ) && (
          /* contradiction in antecedent */ debugT("Foo 2-2b") & la(hideT, "y_1-y_0<=t_3*(v_1-a()/2*t_3)", "-t_3*V()<=yo_2-yo_1", "-B<=a()") & ls(hideT
          , "yo_2-y_1>v_1^2/(2*B)+V()*(v_1/B)") & QE,
          /* contradiction in antecedent */
          QE
          )
        )
  ...
  val accelerateFinishT = la(hideT, "r_1()!=0", "w*r_1()=v_0") & onBranch(
    ...
    ("Know y", debugT("Baz") & la(hideT,
      "(y_0-yo_0>=0->y_0-yo_0>v_0^2/(2*B)+V()*(v_0/B))&(y_0-yo_0<=0->yo_0-y_0>v_0^2/(2*B)+V()*(v_0/B))") & accelerateFinishBaseT)
  )
  ...
  ls(ImplyRightT) & (la(AndLeftT)*) & ls(inductionT(Some(invariant))) & onBranch(
    ...
    (indUseCaseLbl, debugT("Use case") & la(hideT,
      "(x-xo>=0->x-xo>v^2/(2*B)+V()*(v/B))&(x-xo<=0->xo-x>v^2/(2*B)+V()*(v/B))|(y-yo>=0->y-yo>v^2/(2*B)+V()*(v/B))&(y-yo<=0->yo-y>v^2/(2*B)+V()*(v/B))") & ls(
