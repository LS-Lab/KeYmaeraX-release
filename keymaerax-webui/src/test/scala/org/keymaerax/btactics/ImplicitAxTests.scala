...
import org.keymaerax.parser.{ArchiveParser, InterpretedSymbols}
...
class ImplicitAxTests extends TacticTestBase {
  ...
  "definitions" should "derive defining axiom" in withMathematica { _ =>
    ...
    ax.get.provable.conclusion shouldBe
      "==> ._0=exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0)>>(._1)<-><{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0)"
        .asSequent
  }
  ...
  it should "derive defining axiom 2" in withMathematica { _ =>
    ...
    ax1.get.provable.conclusion shouldBe
      "==>  ._0=sin<< <{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0) >>(._1)<-><{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)"
        .asSequent
    ax2.get.provable.conclusion shouldBe
      "==>  ._0=cos<< <{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0) >>(._1)<-><{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)"
        .asSequent
  }
  ...
  it should "derive defining axiom 3" in withMathematica { _ =>
    ...
    val tanh = Function(
      ...
      Real,
      Real,
      Some("<{tanh:=._0;t_:=._1;}{{tanh'=-(1-tanh^2),t_'=-(1)}++{tanh'=1-tanh^2,t_'=1}}>(tanh=0&t_=100)".asFormula),
    )
    ...
    ax.isDefined shouldBe true
    ax.get.provable.conclusion shouldBe
      "==>  ._0=tanh<< <{tanh:=._0;t_:=._1;}{{tanh'=-(1-tanh^2),t_'=-(1)}++{tanh'=1-tanh^2,t_'=1}}>(tanh=0&t_=100) >>(._1)<-><{tanh:=._0;t_:=._1;}{{tanh'=-(1-tanh^2),t_'=-(1)}++{tanh'=1-tanh^2,t_'=1}}>(tanh=0&t_=100)"
        .asSequent
  }
  ...
  it should "derive defining axiom 4" in withMathematica { _ =>
    ...
    val exp = Function(
      ...
      Real,
      Real,
      Some("<{ee:=._0;t_:=._1;}{{ee'=-exp(t_)*ee,t_'=-(1)}++{ee'=exp(t_)*ee,t_'=1}}>(ee=1&t_=0)".asFormula),
    )
  ...
  it should "derive defining axiom 5" in withMathematica { _ =>
    ...
    val exp = Function(
      ...
      Real,
      Some(
        "<{eee:=._0;t_:=._1;}{{eee'=-eee*exp(t_^2),t_'=-(1)}++{eee'=eee*exp(t_^2),t_'=1}}>(eee=sin(1+cos(2))&t_=sin(0))"
          .asFormula
      ),
    )
    val exp2 = Function(
      ...
      Real,
      Some(
        "<{eee:=._0;t_:=._1;}{{eee'=-eee*exp(t_),t_'=-(1)}++{eee'=eee*exp(t_),t_'=1}}>(eee=sin(1+cos(2))&t_=sin(0))"
          .asFormula
      ),
    )
  ...
  "reverse" should "prove there and back style axiom" in withMathematica { _ =>
    ...
    pr.conclusion shouldBe
      "==> p_(x__1,x__2)->[{x__1'=f__1(x__1,x__2),x__2'=f__2(x__1,x__2)&q_(x__1,x__2)}]<{x__1'=-f__1(x__1,x__2),x__2'=-f__2(x__1,x__2)&q_(x__1,x__2)}>p_(x__1,x__2)"
        .asSequent
  }
  ...
  it should "prove forward partial derivatives" in withMathematica { _ =>
    ...
    pr shouldBe Symbol("proved")
    pr.conclusion shouldBe
      "==>  [{x__1'=f__1(x__1,x__2,t_),x__2'=f__2(x__1,x__2,t_),t_'=h_()}](x__1=g__1(t_)&x__2=g__2(t_))->[t_':=h_();]((g__1(t_))'=f__1(g__1(t_),g__2(t_),t_)&(g__2(t_))'=f__2(g__1(t_),g__2(t_),t_))"
        .asSequent
  }
  ...
  "derive diff ax" should "derive differential axiom" in withMathematica { _ =>
    ...
    axs(0).conclusion shouldBe
      "==>  (exp<<<{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0)>>(g(|TDIFFAX_|)))'=exp<<<{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0)>>(g(|TDIFFAX_|))*(g(|TDIFFAX_|))'"
        .asSequent
  }
  ...
  it should "derive differential axiom 2" in withMathematica { _ =>
    ...
    axs(0) shouldBe Symbol("proved")
    axs(1) shouldBe Symbol("proved")
    axs(0).conclusion shouldBe
      "==>  (sin<<<{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))'=cos<<<{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|))*(g(|TDIFFAX_|))'"
        .asSequent
    axs(1).conclusion shouldBe
      "==>  (cos<<<{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))'=(-sin<<<{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))*(g(|TDIFFAX_|))'"
        .asSequent
  }
  ...
  it should "derive differential axiom with time" in withMathematica { _ =>
    val exp = Function(
      ...
      sort = Real,
      interp =
        Some( /* ._0 = exp(._1) <-> */ "<{e:=._0; t :=._1;} {{e'=-(t),t'=-(1)} ++ {e'=t,t'=1}}> (e=1 & t=0)".asFormula),
    )
    ...
    axs(0) shouldBe Symbol("proved")
    axs(0).conclusion shouldBe
      "==>  (expt<< <{e:=._0;t:=._1;}{{e'=-t,t'=-(1)}++{e'=t,t'=1}}>(e=1&t=0) >>(g(|TDIFFAX_|)))'=g(|TDIFFAX_|)*(g(|TDIFFAX_|))'"
        .asSequent
  ...
  it should "derive differential axiom with weird init" in withMathematica { _ =>
    val exp = Function(
      ...
      sort = Real,
      interp =
        Some( /* ._0 = exp(._1) <-> */ "<{e:=._0; t :=._1;} {{e'=-(t),t'=-(1)} ++ {e'=t,t'=1}}> (e=1 & t=10)".asFormula),
    )
    ...
    axs(0) shouldBe Symbol("proved")
    axs(0).conclusion shouldBe
      "==>  (exptt<< <{e:=._0;t:=._1;}{{e'=-t,t'=-(1)}++{e'=t,t'=1}}>(e=1&t=10) >>(g(|TDIFFAX_|)))'=g(|TDIFFAX_|)*(g(|TDIFFAX_|))'"
        .asSequent
  ...
  it should "derive dependent differential axiom" in withMathematica { _ =>
    val exp = Function(
      ...
      sort = Real,
      interp = Some(
        /* ._0 = exp(._1) <-> */ "<{e:=._0; t :=._1;} {{e'=-(exp(t)*e),t'=-(1)} ++ {e'=exp(t)*e,t'=1}}> (e=1 & t=10)"
          .asFormula
      ),
    )
    ...
    axs(0) shouldBe Symbol("proved")
    axs(0).conclusion shouldBe
      "==>  (expA<< <{e:=._0;t:=._1;}{{e'=-exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0) >>(t)*e,t'=-(1)}++{e'=exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0) >>(t)*e,t'=1}}>(e=1&t=10) >>(g(|TDIFFAX_|)))'=exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0) >>(g(|TDIFFAX_|))*expA<< <{e:=._0;t:=._1;}{{e'=-exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0) >>(t)*e,t'=-(1)}++{e'=exp<< <{exp:=._0;t:=._1;}{{exp'=-exp,t'=-(1)}++{exp'=exp,t'=1}}>(exp=1&t=0) >>(t)*e,t'=1}}>(e=1&t=10) >>(g(|TDIFFAX_|))*(g(|TDIFFAX_|))'"
        .asSequent
  ...
  it should "derive differential axiom nested" in withMathematica { _ =>
    val exp = Function(
      ...
      sort = Real,
      interp =
        Some("<{expB:=._0;t:=._1;}{{expB'=-exp(t)*expB,t'=-(1)}++{expB'=exp(t)*expB,t'=1}}>(expB=100&t=0) ".asFormula),
    )
...
//    axs(0).conclusion shouldBe "==>  (exp<< <{e:=._0;t:=._1;}{{e'=-t,t'=-(1)}++{e'=t,t'=1}}>(e=1&t=10) >>(g(|TDIFFAX_|)))'=g(|TDIFFAX_|)*(g(|TDIFFAX_|))'".asSequent
  ...
  it should "derive differential axiom from single" in withMathematica { _ =>
    ...
    axs(0)._2 shouldBe Symbol("proved")
    axs(1)._2 shouldBe Symbol("proved")
    axs(0)._2.conclusion shouldBe
      "==>  (sin<<<{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))'=cos<<<{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|))*(g(|TDIFFAX_|))'"
        .asSequent
    axs(1)._2.conclusion shouldBe
      "==>  (cos<<<{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))'=(-sin<<<{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0)>>(g(|TDIFFAX_|)))*(g(|TDIFFAX_|))'"
        .asSequent
  }
  ...
  it should "derive and store diff ax 2" in withMathematica { _ =>
    ...
    dcos.get.provable shouldBe Symbol("proved")
  }
  ...
  it should "detect multiple definitions with same function name 1" in withMathematica { _ =>
    ...
    val exp2 = Function(
      ...
      Real,
      Real,
      Some("<{exp:=._0;t_:=._1;}{{exp'=-exp,t_'=-(1)}++{exp'=exp,t_'=1}}>(exp=2&t_=0)".asFormula),
    )
    val dexp = getDiffAx(exp)

    the[Exception] thrownBy getDiffAx(exp2) should have message
  ...
  it should "detect multiple definitions with same function name 2" in withMathematica { _ =>
    ...
    the[Exception] thrownBy getInitAx(exp2) should have message
      "Duplicate function names with different interpretations used in same session."
  }
  ...
  it should "detect multiple definitions with same function name 3" in withMathematica { _ =>
    ...
    the[Exception] thrownBy getDefAx(exp2) should have message
      "Duplicate function names with different interpretations used in same session."
  }
  ...
  it should "prove exp non-negative" in withMathematica { _ =>
    ...
    val pr = proveBy(
      Greater(FuncOf(exp, "f()".asTerm), Number(0)),
  ...
  it should "manual proof with weird subexpression" in withMathematica { _ =>
    ...
    // exp(y+g(x)) > 0
    val pr = proveBy(
      Greater(FuncOf(exp, "y+g(x)".asTerm), Number(0)),
  ...
  it should "multivariate manual proof sin/cos 2" in withMathematica { _ =>
    ...
    val p1 = Minus(FuncOf(sin, Plus(v, y)), Plus(Times(sinv, cosy), Times(cosv, siny)))
    val p2 = Minus(FuncOf(cos, Plus(v, y)), Minus(Times(cosv, cosy), Times(sinv, siny)))
    ...
    val pr = proveBy(
      And(
        ...
        Equal(FuncOf(cos, Plus(x, y)), Minus(Times(cosx, cosy), Times(sinx, siny))),
      ),
  ...
  it should "expand abbreviations of interpreted symbols in ODE" in withMathematica { _ =>
    val entry = ArchiveParser(
      """ArchiveEntry "exp"
        |Definitions implicit Real e2(Real t) = {{e2:=1;t:=2;}; {e2'=-e2,t'=1}}; End.
    ...
    proveBy(
      entry.sequent,
      ImplicitAx.diffUnfold(Variable("x"), Number(2))(1) < (QE, ODE(1), ODE(1)),
      entry.defs,
  ...
  it should "diff unfold D existentials" in withMathematica { _ =>
    val pr = proveBy(
      "k > 0 -> \\exists x ( x >= l & exp(-x) < k )".asFormula,
      implyR(1) & diffUnfoldD("l".asTerm)(1) & orR(1) & hideR(2) &
  ...
  it should "work correctly with composition" in withMathematica { _ =>
    val pr = proveBy(
      "v=0 -> [{v'=1&v<=x()}]arctan<< <{arctan:=._0;t:=._1;}{{arctan'=-(1/(1+t^2)),t'=-(1)}++{arctan'=1/(1+t^2),t'=1}}>(arctan=0&t=0) >>(sin<< <{cos:=*;sin:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0) >>(v)/cos<< <{sin:=*;cos:=._0;t:=._1;}{{sin'=-cos,cos'=--sin,t'=-(1)}++{sin'=cos,cos'=-sin,t'=1}}>(sin=0&cos=1&t=0) >>(v))=v"
        .asFormula,
  ...
  it should "work with composition correctly 2" in withMathematica { _ =>
    val pr = proveBy(
      "v=0, exp2<< <{exp2:=._0;t:=._1;}{{exp2'=-exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(t)*exp2,t'=-(1)}++{exp2'=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(t)*exp2,t'=1}}>(exp2=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(1)&t=0) >>(v)=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(v))\n  ==>  [{v'=1&v<=x()}]exp2<< <{exp2:=._0;t:=._1;}{{exp2'=-exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(t)*exp2,t'=-(1)}++{exp2'=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(t)*exp2,t'=1}}>(exp2=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(1)&t=0) >>(v)=exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(exp1<< <{exp1:=._0;t:=._1;}{{exp1'=-exp1,t'=-(1)}++{exp1'=exp1,t'=1}}>(exp1=1&t=0) >>(v))"
        .asSequent,
      ODEInvariance.dRI(1),
    )
