...
class ARCHNonlinearBenchmark extends TacticTestBase {
  ...
  "ODE" should "prove some examples with Z3" taggedAs SlowTest in withZ3 { _ =>
    forEvery(Table("Formula", z3Benchmarks*)) { (fml: Formula) =>
