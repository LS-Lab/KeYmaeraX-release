...
import org.keymaerax.core.{Equiv, Power, Sequent, Term}
import org.keymaerax.parser.StringConverter._
import org.keymaerax.tagobjects.TodoTest
import org.keymaerax.tools.install.Z3Installer
import org.keymaerax.tools.qe.{DefaultSMTConverter, SMTConverter, Z3Solver}
...
class SMTQETests extends TacticTestBase {
  ...
  "Simplify" should "simplify term" in withZ3 { tool => tool.simplify("1+x-x".asTerm, Nil) should be("1".asTerm) }

  // ---------------------------
  // Basics
  // ---------------------------

  private val basicExamples = Table(
  ...
  "Z3" should "prove every basic example" in withZ3 { z3 =>
    forEvery(basicExamples) { (name, input, expected) =>
      whenever(z3.isInitialized) {
        withClue(name) {
          inside(z3.qe(input).fact.conclusion) { case Sequent(_, IndexedSeq(Equiv(_, r))) => r shouldBe expected }
        }
      }
    }
  }
  ...
  private val complicatedExamples = Table(
    ("Name", "Formula", "Expected"),
    ...
    (
      "Complex 2",
      "(c<1&c>=0&H>=0&g()>0&v^2<=2*g()*(H-h)&h>=0&kxtime_1=0&h_2()=h&v_2()=v&h_3=0&kxtime_4()=0&v_3=-1*kxtime_5*g()+v&0>=0&0=1/2*(-1*kxtime_5^2*g()+2*h+2*kxtime_5*v)&kxtime_5>=0&v_5=-c*(-1*kxtime_5*g()+v)->(-c*(-1*kxtime_5*g()+v))^2<=2*g()*(H-0))"
        .asFormula,
      "true".asFormula,
    ),
    (
      "Complex 3",
      "c<1 & c>=0 & H>=0 & g()>0 & v^2<=2*g()*(H-h) & h>=0 & kxtime_1=0 & h_2()=h & v_2()=v & h>=0 & kxtime_4()=0 & 0>=0 -> v=(0*2-1*0)/2^2*(-1*0^2*g()+2*h+2*0*v)+1/2*((-0*0^2+-1*(2*0^1*(0*0+1)))*g()+-1*0^2*0+(0*h+2*0)+((0*0+2*(0*0+1))*v+2*0*0))"
        .asFormula,
      "true".asFormula,
    ),
  ...
  "Z3" should "prove every complicated example" in withZ3 { z3 =>
    forEvery(complicatedExamples) { (name, input, expected) =>
      whenever(z3.isInitialized) {
        withClue(name) {
          inside(z3.qe(input).fact.conclusion) { case Sequent(_, IndexedSeq(Equiv(_, r))) => r shouldBe expected }
        }
  ...
  private val regressionExamples = Table(
    ("Name", "Formula", "Expected"),
    (
      "STTT Tutorial Example 5 simplectrl",
      "\\forall x_6 \\forall x_5 \\forall x_4 \\forall v_6 \\forall v_5 \\forall v_4 \\forall ep_0 \\forall c_9 \\forall c_8 \\forall c_7 \\forall a_2 \\forall S_0 \\forall B_0 \\forall A_0 ((((((((((((((A_0>0&B_0>0)&ep_0>0)&a_2=-B_0)&c_9=0)&v_6>=0)&x_4+v_6^2/(2*B_0)<=S_0)&x_5=x_4)&v_4=v_6)&c_7<=ep_0)&c_8=0)&c_7>=0)&v_5=v_6+-B_0*(c_7-0))&x_6=1/2*(2*x_4+2*v_6*(c_7-0)+-B_0*(c_7-0)^2))&v_6+-B_0*(c_7-0)>=0->1/2*(2*x_4+2*v_6*(c_7-0)+-B_0*(c_7-0)^2)+(v_6+-B_0*(c_7-0))^2/(2*B_0)<=S_0)"
        .asFormula,
      "true".asFormula,
    ),
    ...
    (
      "STTT Tutorial Example 5 subgoal 2",
      "\\forall x_6 \\forall x_5 \\forall x_4 \\forall v_6 \\forall v_5 \\forall v_4 \\forall ep_0 \\forall c_9 \\forall c_8 \\forall c_7 \\forall a_2 \\forall S_0 \\forall B_0 \\forall A_0 ((((((((((((((A_0>0&B_0>0)&ep_0>0)&v_4>=0)&x_6+v_4^2/(2*B_0)<=S_0)&a_2=-B_0)&c_9=0)&x_5=x_6)&v_6=v_4)&c_8<=ep_0)&c_7=0)&c_8>=0)&v_5=v_4+-B_0*(c_8-0))&x_4=1/2*(2*x_6+2*v_4*(c_8-0)+-B_0*(c_8-0)^2))&v_4+-B_0*(c_8-0)>=0->1/2*(2*x_6+2*v_4*(c_8-0)+-B_0*(c_8-0)^2)+(v_4+-B_0*(c_8-0))^2/(2*B_0)<=S_0)"
        .asFormula,
      "true".asFormula,
    ),
    ...
    (
      "STTT Tutorial Example 6 subgoal 2",
      "\\forall x_6 \\forall x_5 \\forall x_4 \\forall v_6 \\forall v_5 \\forall v_4 \\forall ep_0 \\forall c_9 \\forall c_8 \\forall c_7 \\forall a_2 \\forall S_0 \\forall B_0 \\forall A_0 ((((((((((((((A_0>0&B_0>0)&ep_0>0)&v_4>=0)&x_6+v_4^2/(2*B_0)<=S_0)&a_2=-B_0)&c_9=0)&x_5=x_6)&v_6=v_4)&c_8<=ep_0)&c_7=0)&c_8>=0)&v_5=v_4+-B_0*(c_8-0))&x_4=1/2*(2*x_6+2*v_4*(c_8-0)+-B_0*(c_8-0)^2))&v_4+-B_0*(c_8-0)>=0->1/2*(2*x_6+2*v_4*(c_8-0)+-B_0*(c_8-0)^2)+(v_4+-B_0*(c_8-0))^2/(2*B_0)<=S_0)"
        .asFormula,
      "true".asFormula,
    ),
  ...
  private val onceProvableExamples = Table(
    ("Name", "Formula", "Expected"),
    (
  ...
  "Z3" should "prove every regression example" in withZ3 { z3 =>
    ...
    forEvery(regressionExamples) { (name, input, expected) =>
      whenever(z3.isInitialized) {
        withClue(name) {
          inside(z3.qe(input).fact.conclusion) { case Sequent(_, IndexedSeq(Equiv(_, r))) => r shouldBe expected }
        }
  ...
  it should "FEATURE_REQUEST: prove once provable examples" taggedAs TodoTest in withZ3 { z3 =>
    z3.setOperationTimeout(30)
    forEvery(onceProvableExamples) { (name, input, expected) =>
      whenever(z3.isInitialized) {
        withClue(name) {
          inside(z3.qe(input).fact.conclusion) { case Sequent(_, IndexedSeq(Equiv(_, r))) => r shouldBe expected }
        }
  ...
  it should "not exceed a timeout" ignore withZ3 { z3 =>
    ...
    val f =
      "\\forall x_0 \\forall v_0 \\forall t__0 \\forall ep_0 \\forall S_0 \\forall B_0 \\forall A_0 (A_0>0&B_0>0&ep_0>0&x_0+v_0^2/(2*B_0)+(A_0/B_0+1)*(A_0/2*ep_0^2+ep_0*v_0)<=S_0&t__0>=0&\\forall s_ (0<=s_&s_<=t__0->A_0*s_+v_0>=0&s_+0<=ep_0)&v_0>=0&x_0+v_0^2/(2*B_0)<=S_0->A_0/2*t__0^2+v_0*t__0+x_0+(A_0*t__0+v_0)^2/(2*B_0)<=S_0)"
        .asFormula
  ...
  "Z3Reports" should "prove intervalUpDivide" in withZ3 { z3 =>
    val intervalUpDivideStr =
      "\\forall yy \\forall xx \\forall Y \\forall X \\forall z \\forall y \\forall x (x/y<=z <- (((xx<=x & x<=X) & (yy<=y & y<=Y)) & ((Y<0|0<yy) &(xx/yy<=z & xx/Y<=z & X/yy<=z & X/Y<=z))))"
    z3.qe(intervalUpDivideStr.asFormula).fact shouldBe Symbol("proved")
  }

  it should "prove intervalDownDivide" in withZ3 { z3 =>
    val intervalDownDivideStr =
      "\\forall yy \\forall xx \\forall Y \\forall X \\forall z \\forall y \\forall x (z<=x/y <- (((xx<=x & x<=X) & (yy<=y & y<=Y)) & ((Y<0|0<yy) &(z<=xx/yy & z<=xx/Y & z<=X/yy & z<=X/Y))))"
