...
//
  ...
  "Fixedwing" should "find correct controller monitory" in withMathematica { implicit tool =>
    ...
    simplifiedResult.subgoals should have size 1
    simplifiedResult.subgoals.head.ante shouldBe empty
    simplifiedResult.subgoals.head.succ should contain only "(v=Vmin&(theta=Theta&((dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=0&wpost()=0)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|theta=-Theta&((theta!=Theta|dxy=dXY&dz=dZ)&dxy=-dXY&dz=dZ)&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=0&wpost()=0)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|(0<=theta&theta < Theta)&((theta!=Theta|dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY&dz=dZ))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=0&wpost()=W)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|(-Theta < theta&theta < 0)&((theta!=Theta|dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY&dz=dZ))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=0&wpost()=-W)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy)|v>Vmin&(theta=Theta&((dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=-B&wpost()=0)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|theta=-Theta&((theta!=Theta|dxy=dXY&dz=dZ)&dxy=-dXY&dz=dZ)&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=-B&wpost()=0)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|(0<=theta&theta < Theta)&((theta!=Theta|dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY&dz=dZ))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=-B&wpost()=W)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy|(-Theta < theta&theta < 0)&((theta!=Theta|dxy=dXY&dz=dZ)&(theta!=-Theta|dxy=-dXY&dz=dZ))&(0<=ep&v>=Vmin&-Theta<=theta&theta<=Theta)&(((((((((((apost()=-B&wpost()=-W)&xopost()=xo)&thetapost()=theta)&dxypost()=dxy)&ypost()=y)&tpost()=0)&vpost()=v)&dxpost()=dx)&yopost()=yo)&dzpost()=dz)&xpost()=x)&dypost()=dy))|(-B<=apost()&apost()<=A)&(-W<=wpost()&wpost()<=W)&vpost()>=Vmin&(-Theta<=thetapost()&thetapost()<=Theta)&(abs(x-xopost())>(vpost()^2-Vmin^2)/(2*B)+2*r+(A/B+1)*(A/2*ep^2+ep*vpost())&abs(x-xopost())>(vpost()^2-Vmin^2)/(2*B)+Vmin*((Theta-abs(thetapost()))/W-(vpost()-Vmin)/B)+2*r+(A/B+1)*(A/2*ep^2+ep*vpost())+Vmin*ep|abs(y-yopost())>(vpost()^2-Vmin^2)/(2*B)+2*r+(A/B+1)*(A/2*ep^2+ep*vpost())&abs(y-yopost())>(vpost()^2-Vmin^2)/(2*B)+Vmin*((Theta-abs(thetapost()))/W-(vpost()-Vmin)/B)+2*r+(A/B+1)*(A/2*ep^2+ep*vpost())+Vmin*ep)&0<=ep&(((((dxypost()=dxy&ypost()=y)&tpost()=0)&dxpost()=dx)&dzpost()=dz)&xpost()=x)&dypost()=dy".asFormula
...
//
  ...
  it should "extract the correct controller monitor by updateCalculus implicationally" in withMathematica { tool =>
    ...
    simplifiedResult.subgoals should have size 1
    simplifiedResult.subgoals.head.ante shouldBe empty
    simplifiedResult.subgoals.head.succ should contain only "(h>0&((kp < 0&v=0|kp < 0&v>0&2*h*kp+v*(kd()+y)=2*h*kp&h*y>h*kd()+2*v|kp < 0&v < 0&2*h*kp+v*y=2*h*kp+kd()*v&2*v+h*(kd()+y)>0|kp>0&v=0|kp>0&v>0&(2*h*kp+v*(kd()+y)=2*h*kp&h*y>h*kd()+2*v&kd()+2*sqrkp<=0|2*h*kp+v*(kd()+y)=2*h*kp&kd()+2*sqrkp < 0&2*v+h*(kd()+y) < 0|2*h*kp+v*y=2*h*kp+kd()*v&kd()+2*sqrkp < 0&2*v+h*(kd()+y) < 0|2*h*kp+v*(kd()+y)=2*h*kp&kd()>2*sqrkp&2*v+h*(kd()+y)>0&h*y>=h*kd()+2*v)|kp>0&v < 0&(2*h*kp+v*(kd()+y)=2*h*kp&kd()>2*sqrkp&h*y < h*kd()+2*v|2*h*kp+v*y=2*h*kp+kd()*v&kd()>=2*sqrkp&h*y < h*kd()+2*v|2*h*kp+v*y=2*h*kp+kd()*v&kd()>2*sqrkp&2*v+h*(kd()+y)>0&h*y>=h*kd()+2*v|2*h*kp+v*y=2*h*kp+kd()*v&h*y>h*kd()+2*v&2*v+h*(kd()+y)>=0&kd()+2*sqrkp < 0))&(y^2=kd()^2-4*kp&y>=0)&(sqrkp^2=kp&sqrkp>=0)&h^2*kp^2-2*h*h*kp^2+h^2*kp^2+h*kd()*kp*v-h*kd()*kp*v+kp*v^2!=0|(kp < 0&v=0&(h*y<=h*kd()|h*(kd()+y)<=0)|kp < 0&v < 0&(h*y<=h*kd()+2*v|2*v+h*(kd()+y)<=0|2*h*kp+kd()*v!=2*h*kp+v*y)|kp < 0&v>0&(h*y<=h*kd()+2*v|2*v+h*(kd()+y)<=0|2*h*kp+v*(kd()+y)!=2*h*kp)|kp>0&v=0&(kd()=2*sqrkp&h*y>=h*kd()|kd() < 2*sqrkp&kd()+2*sqrkp>0|kd()>2*sqrkp&h*(kd()+y)<=0|kd()+2*sqrkp<=0&h*y<=h*kd())|kp>0&v < 0&(2*h*kp+v*y!=2*h*kp+kd()*v&(h*y>=h*kd()+2*v|kd()<=2*sqrkp)|kd() < 2*sqrkp|kd()>2*sqrkp&(h*y < h*kd()+2*v&(2*h*kp+v*y < 2*h*kp+kd()*v&2*h*kp+v*(kd()+y) < 2*h*kp|2*h*kp+v*y>2*h*kp+kd()*v|2*h*kp+v*(kd()+y)>2*h*kp)|2*v+h*(kd()+y)<=0)|h*y>=h*kd()+2*v&kd()<=2*sqrkp|kd()+2*sqrkp<=0)|kp>0&v>0&(2*h*kp+v*(kd()+y)!=2*h*kp&(kd()+2*sqrkp>=0|2*v+h*(kd()+y)>=0)|kd()>=2*sqrkp|kd()+2*sqrkp < 0&2*v+h*(kd()+y) < 0&(2*h*kp+v*y < 2*h*kp+kd()*v|2*h*kp+v*(kd()+y) < 2*h*kp|2*h*kp+v*y>2*h*kp+kd()*v&2*h*kp+v*(kd()+y)>2*h*kp)|kd()+2*sqrkp>0|h*y<=h*kd()+2*v))&y^2=kd()^2-4*kp&y>=0&sqrkp^2=kp&sqrkp>=0&h^2*kp^2-2*h*h*kp^2+h^2*kp^2+h*kd()*kp*v-h*kd()*kp*v+kp*v^2=0))&(hrefpost()=h&vpost()=v)&hpost()=h".asFormula
