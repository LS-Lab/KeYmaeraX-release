...
object CondCongruence {
   ...
   * @author Andre Platzer
   */
  def acasXcongruence(implicitExplicit: Provable, acasximplicitP: Provable, ucLoLemma: Provable, acasxexplicit: Formula, done: BelleExpr = close): Provable = {
   ...
   * @author Andre Platzer
   */
  def acasXTLcongruence(implicitExplicit: Provable, acasximplicitP: Provable, ucLoLemma: Provable, acasxexplicit: Formula, done: BelleExpr = close): Provable = {
