...
class LauncherTests extends FlatSpec with Matchers with BeforeAndAfterEach {
  ...
  "Launcher" should "prove the bouncing ball from command line with scala tactic" taggedAs KeYmaeraXTestTags.IgnoreInBuildTest in {
  ...
  it should "prove the bouncing ball from command line with kyt tactic" taggedAs KeYmaeraXTestTags.IgnoreInBuildTest in {
    val inputFileName = "keymaerax-webui/src/test/resources/examples/simple/bouncing-ball/bouncing-ball-tout.key"
