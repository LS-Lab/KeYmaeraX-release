...
class CCodeGeneratorTests extends TacticTestBase {
  ...
  private def expectedMonitor(paramDecl: String, stateDecl: String, compiledMonitorExpr: String,
                              kind: String="boolean"): String = {
    val retType = kind match {
      case "boolean" => "bool"
      case "metric" => "long double"
    }
  ...
  "variables" should "compile with index" in {
    ...
    (new CGenerator(new CMonitorGenerator()))("x*z-y_1>1".asFormula, Set(Variable("x"))) shouldBe expectedMonitor(paramDecls, stateDecls,
      "(((pre.x)*(params.z)) - (params.y_1))>((1))")
  }

  "nullary functions" should "compile to parameters" in {
    (new CGenerator(new CMonitorGenerator()))("x()>1".asFormula) shouldBe expectedMonitor("long double x;", "", "(params.x)>((1))")
  }

  "power" should "compile int exp" in {
    (new CGenerator(new CMonitorGenerator()))("x^3>1".asFormula) shouldBe expectedMonitor("long double x;", "",
      "(((params.x)*(params.x)*(params.x)))>((1))")
  }
  ...
  it should "compile neg int exp" in {
    ...
    (new CGenerator(new CMonitorGenerator()))("(x+y)^-3>1".asFormula) shouldBe expectedMonitor(paramDecls, "",
      "((1.0/(((params.x) + (params.y))*((params.x) + (params.y))*((params.x) + (params.y)))))>((1))")
  }
  ...
  it should "compile any exp" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    (new CGenerator(new CMonitorGenerator()))("x^y>1".asFormula) shouldBe expectedMonitor(paramDecls, "", "((pow((params.x),(params.y))))>((1))")
  }
  ...
  "abs" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    (new CGenerator(new CMonitorGenerator()))("abs(x-y)>0".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fabsl((params.x) - (params.y)))>((0))")
  }
  ...
  "min" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    (new CGenerator(new CMonitorGenerator()))("min(x,y)<=x".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fminl(params.x, params.y))<=(params.x)")
  }
  ...
  "max" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    (new CGenerator(new CMonitorGenerator()))("max(x,y)>=x".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fmaxl(params.x, params.y))>=(params.x)")
  }
  ...
  "robix" should "generate C code for passivesafety" in {
    ...
    (new CGenerator(new CMonitorGenerator()))(monitorExp, Set(Variable("a"),Variable("w"),Variable("r"),Variable("xo"),Variable("yo"),
      Variable("dxo"),Variable("dyo"),Variable("t"))) shouldBe expectedMonitor(paramDecls, stateDecls,
  ...
  it should "generate C code for passivesafetyabs" in {
    ...
    val stateDecls =
      """long double a;
        ...
        |  long double y;
        |  long double yo;""".stripMargin
    (new CGenerator(new CMonitorGenerator()))(monitorExp, vars) shouldBe expectedMonitor(paramDecls, stateDecls, "(((((curr.dxo)*(curr.dxo))) + (((curr.dyo)*(curr.dyo))))<=(((params.V)*(params.V))))&&((((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(pre.xo))&&((curr.yo)==(pre.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==(pre.w)))&&((curr.a)==(-(params.B))))&&((curr.r)==(pre.r)))&&((curr.t)==((0)))))||((((pre.v)==((0)))&&(((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(pre.xo))&&((curr.yo)==(pre.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==((0))))&&((curr.a)==((0))))&&((curr.r)==(pre.r)))&&((curr.t)==((0))))))||((((-(params.B))<=(curr.a))&&((curr.a)<=(params.A)))&&(((curr.r)!=((0)))&&((((curr.w)*(curr.r))==(pre.v))&&((((fabsl((pre.x) - (curr.xo)))>((((((pre.v)*(pre.v)))/(((2))*(params.B))) + (((params.V)*(pre.v))/(params.B))) + ((((params.A)/(params.B)) + ((1)))*((((params.A)/((2)))*(((params.ep)*(params.ep)))) + ((params.ep)*((pre.v) + (params.V)))))))||((fabsl((pre.y) - (curr.yo)))>((((((pre.v)*(pre.v)))/(((2))*(params.B))) + (((params.V)*(pre.v))/(params.B))) + ((((params.A)/(params.B)) + ((1)))*((((params.A)/((2)))*(((params.ep)*(params.ep)))) + ((params.ep)*((pre.v) + (params.V))))))))&&(((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(curr.xo))&&((curr.yo)==(curr.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==(curr.w)))&&((curr.a)==(curr.a)))&&((curr.r)==(curr.r)))&&((curr.t)==((0)))))))))))")
  }
  ...
  it should "generate metric C code for passivesafetyabs" in withMathematica { _ =>
    ...
    val stateDecls =
      """long double a;
        ...
        |  long double y;
        |  long double yo;""".stripMargin
    (new CGenerator(new CMonitorGenerator("metric")))(monitorExp, vars) shouldBe expectedMonitor(paramDecls, stateDecls,
...
//    afterEach()
  ...
  "quadcopter" should "generate C code for hybridquadrotor" in {
    ...
    code shouldBe expectedMonitor(paramDecls, "long double href;", "((params.h)>=(curr.href))&&(((curr.href)>((0)))&&(((((((params.kp)<((0)))&&(((params.v)==((0)))&&((curr.href)>=(params.h))))||((((params.kp)<((0)))&&(((params.v)>((0)))&&(((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))==((((2))*(curr.href))*(params.kp)))&&(((params.h)*(params.y))>(((params.h)*(params.kd)) + (((2))*(params.v)))))))||((((params.kp)<((0)))&&(((params.v)<((0)))&&(((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))==(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&(((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))>((0))))))||((((params.kp)>((0)))&&(((params.v)==((0)))&&((curr.href)==(params.h))))||((((params.kp)>((0)))&&(((params.v)>((0)))&&((((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))==((((2))*(curr.href))*(params.kp)))&&((((params.h)*(params.y))>(((params.h)*(params.kd)) + (((2))*(params.v))))&&(((params.kd) + (((2))*(params.sqrkp)))<=((0)))))||((((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))==((((2))*(curr.href))*(params.kp)))&&((((params.kd) + (((2))*(params.sqrkp)))<((0)))&&(((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<((0)))))||((((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))==(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&((((params.kd) + (((2))*(params.sqrkp)))<((0)))&&(((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<((0)))))||(((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))==((((2))*(curr.href))*(params.kp)))&&(((params.kd)>(((2))*(params.sqrkp)))&&((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))>((0)))&&(((params.h)*(params.y))>=(((params.h)*(params.kd)) + (((2))*(params.v))))))))))))||(((params.kp)>((0)))&&(((params.v)<((0)))&&((((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))==((((2))*(curr.href))*(params.kp)))&&(((params.kd)>(((2))*(params.sqrkp)))&&(((params.h)*(params.y))<(((params.h)*(params.kd)) + (((2))*(params.v))))))||((((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))==(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&(((params.kd)>=(((2))*(params.sqrkp)))&&(((params.h)*(params.y))<(((params.h)*(params.kd)) + (((2))*(params.v))))))||((((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))==(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&(((params.kd)>(((2))*(params.sqrkp)))&&((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))>((0)))&&(((params.h)*(params.y))>=(((params.h)*(params.kd)) + (((2))*(params.v)))))))||(((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))==(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&((((params.h)*(params.y))>(((params.h)*(params.kd)) + (((2))*(params.v))))&&((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))>=((0)))&&(((params.kd) + (((2))*(params.sqrkp)))<((0))))))))))))))))&&((((((params.y)*(params.y)))==((((params.kd)*(params.kd))) - (((4))*(params.kp))))&&((params.y)>=((0))))&&((((((params.sqrkp)*(params.sqrkp)))==(params.kp))&&((params.sqrkp)>=((0))))&&((((((((((params.h)*(params.h)))*(((params.kp)*(params.kp)))) - (((((2))*(params.h))*(curr.href))*(((params.kp)*(params.kp))))) + ((((curr.href)*(curr.href)))*(((params.kp)*(params.kp))))) + ((((params.h)*(params.kd))*(params.kp))*(params.v))) - ((((curr.href)*(params.kd))*(params.kp))*(params.v))) + ((params.kp)*(((params.v)*(params.v)))))!=((0))))))||(((((params.kp)<((0)))&&(((params.v)==((0)))&&((((params.h)*(params.y))<=((params.h)*(params.kd)))||((((params.h)*((params.kd) + (params.y)))<=((0)))||((params.h)>(curr.href))))))||((((params.kp)<((0)))&&(((params.v)<((0)))&&((((params.h)*(params.y))<=(((params.h)*(params.kd)) + (((2))*(params.v))))||((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<=((0)))||((((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v)))!=(((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y))))))))||((((params.kp)<((0)))&&(((params.v)>((0)))&&((((params.h)*(params.y))<=(((params.h)*(params.kd)) + (((2))*(params.v))))||((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<=((0)))||((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))!=((((2))*(curr.href))*(params.kp)))))))||((((params.kp)>((0)))&&(((params.v)==((0)))&&((((params.h)!=(curr.href))&&((((params.kd)>=(((2))*(params.sqrkp)))&&(((params.h)*(params.y))>=((params.h)*(params.kd))))||((((params.h)*((params.kd) + (params.y)))>=((0)))&&(((params.kd) + (((2))*(params.sqrkp)))<((0))))))||((((params.kd)==(((2))*(params.sqrkp)))&&(((params.h)*(params.y))>=((params.h)*(params.kd))))||((((params.kd)<(((2))*(params.sqrkp)))&&(((params.kd) + (((2))*(params.sqrkp)))>((0))))||(((params.h)>(curr.href))||((((params.kd)>(((2))*(params.sqrkp)))&&(((params.h)*((params.kd) + (params.y)))<=((0))))||((((params.kd) + (((2))*(params.sqrkp)))<=((0)))&&(((params.h)*(params.y))<=((params.h)*(params.kd)))))))))))||((((params.kp)>((0)))&&(((params.v)<((0)))&&((((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))!=(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&((((params.h)*(params.y))>=(((params.h)*(params.kd)) + (((2))*(params.v))))||((params.kd)<=(((2))*(params.sqrkp)))))||(((params.kd)<(((2))*(params.sqrkp)))||((((params.kd)>(((2))*(params.sqrkp)))&&(((((params.h)*(params.y))<(((params.h)*(params.kd)) + (((2))*(params.v))))&&((((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))<(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))<((((2))*(curr.href))*(params.kp))))||(((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))>(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))||((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))>((((2))*(curr.href))*(params.kp))))))||(((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<=((0)))))||(((((params.h)*(params.y))>=(((params.h)*(params.kd)) + (((2))*(params.v))))&&((params.kd)<=(((2))*(params.sqrkp))))||(((params.kd) + (((2))*(params.sqrkp)))<=((0)))))))))||(((params.kp)>((0)))&&(((params.v)>((0)))&&((((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))!=((((2))*(curr.href))*(params.kp)))&&((((params.kd) + (((2))*(params.sqrkp)))>=((0)))||(((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))>=((0)))))||(((params.kd)>=(((2))*(params.sqrkp)))||(((((params.kd) + (((2))*(params.sqrkp)))<((0)))&&((((((2))*(params.v)) + ((params.h)*((params.kd) + (params.y))))<((0)))&&(((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))<(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))||(((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))<((((2))*(curr.href))*(params.kp)))||(((((((2))*(curr.href))*(params.kp)) + ((params.v)*(params.y)))>(((((2))*(params.h))*(params.kp)) + ((params.kd)*(params.v))))&&((((((2))*(params.h))*(params.kp)) + ((params.v)*((params.kd) + (params.y))))>((((2))*(curr.href))*(params.kp))))))))||((((params.kd) + (((2))*(params.sqrkp)))>((0)))||(((params.h)*(params.y))<=(((params.h)*(params.kd)) + (((2))*(params.v)))))))))))))))&&(((((params.y)*(params.y)))==((((params.kd)*(params.kd))) - (((4))*(params.kp))))&&(((params.y)>=((0)))&&(((((params.sqrkp)*(params.sqrkp)))==(params.kp))&&(((params.sqrkp)>=((0)))&&((((((((((params.h)*(params.h)))*(((params.kp)*(params.kp)))) - (((((2))*(params.h))*(curr.href))*(((params.kp)*(params.kp))))) + ((((curr.href)*(curr.href)))*(((params.kp)*(params.kp))))) + ((((params.h)*(params.kd))*(params.kp))*(params.v))) - ((((curr.href)*(params.kd))*(params.kp))*(params.v))) + ((params.kp)*(((params.v)*(params.v)))))==((0)))))))))&&((curr.href)==(curr.href))))")
    CodeGenTestTools.compileC(CodeGenTestTools.augmentMonitorMain(code))
  }
  ...
  "Compiled controller monitor" should "evaluate boolean correctly" in {
    ...
    val code =
      s"""
        ...
        |$monitorCode
        |
        |state ctrl(state curr, parameters params, state input) { printf("Controller chooses A\\n"); curr.a = params.A; return curr; }
        |state fallback(state curr, parameters params, state input) { printf("Fallback returns -B\\n"); curr.a = -params.B; return curr; }
        |
        |int main() {
  ...
  it should "translate a nondeterministic assignment into an input lookup" in {
    ...
    cPrg shouldBe
      """state ctrlStep(state curr, parameters params, state inputs) {
        |  struct { state state; int success; } prg = { .state=curr, .success=0 };
        |  prg.state.x = inputs.x; prg.success = 1;
        |  return prg.state;
        |}""".stripMargin
  }
  ...
  it should "compile and run a controller" in {
    ...
    val mainCode =
      s"""
       ...
       |  state input = { .x=0.5 };
       |  printf("Returned x=%1.1Lf\\n", ctrlStep(current, params, input).x);
       |  /* change input */
       |  state nextInput = { .x=2.0 };
       |  printf("Returned x=%1.1Lf", ctrlStep(current, params, nextInput).x);
       |  return 0;
       |}
       |""".stripMargin
  ...
  it should "compile and run a fallback controller of a monitor" in {
    ...
    val code = s"""
       ...
       |$monitorCode
       |
       |state ctrl(state curr, parameters params, state input) { printf("Choosing 2*%1.1Lf", curr.x); curr.x = 2*curr.x; return curr; }
       |
       |int main() {
       |  state current = { .x=0.2 };
       |  parameters params = { .A=1.0 };
       ...
       |  for (int i=0; i<5; ++i) {
       |    state input = { .x=inputSequence[i] };
       |    current = monitoredCtrl(current, params, input, &ctrl, &ctrlStep);
