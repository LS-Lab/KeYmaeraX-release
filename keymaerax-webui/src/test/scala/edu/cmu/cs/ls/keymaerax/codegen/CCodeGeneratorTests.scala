...
class CCodeGeneratorTests extends FlatSpec with Matchers {
  ...
  private def expectedMonitor(paramDecl: String, stateDecl: String, compiledMonitorExpr: String): String =
    s"""/**************************
       | *
       ...
       |state monitoredCtrl(state curr, parameters params, state (*ctrl)(state,parameters), state (*fallback)(state,parameters)) {
       |  state pre = curr;
       |  curr = (*ctrl)(pre,params);
       |  bool monitorSatisfied = $compiledMonitorExpr;
  ...
  "numbers" should "compile floating point" in {
    CGenerator("2+1.5>3.25".asFormula) shouldBe expectedMonitor("", "", "(((2)) + ((1.5)))>((3.25))")
  }

  it should "compile large number" in {
    CGenerator("9223372036854775807>1".asFormula) shouldBe expectedMonitor("", "", "((9223372036854775807))>((1))")
  }
  ...
  "variables" should "compile with index" in {
    ...
    CGenerator("x*z-y_1>1".asFormula, List(Variable("x"))) shouldBe expectedMonitor(paramDecls, stateDecls,
      "(((pre.x)*(params.z)) - (params.y_1))>((1))")
  }

  "nullary functions" should "compile to parameters" in {
    CGenerator("x()>1".asFormula) shouldBe expectedMonitor("long double x;", "", "(params.x)>((1))")
  }

  "power" should "compile int exp" in {
    CGenerator("x^3>1".asFormula) shouldBe expectedMonitor("long double x;", "",
  ...
  it should "compile neg int exp" in {
    ...
    CGenerator("(x+y)^-3>1".asFormula) shouldBe expectedMonitor(paramDecls, "",
  ...
  it should "compile any exp" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    CGenerator("x^y>1".asFormula) shouldBe expectedMonitor(paramDecls, "", "((pow((params.x),(params.y))))>((1))")
  }
  ...
  "abs" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    CGenerator("abs(x-y)>0".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fabsl((params.x) - (params.y)))>((0))")
  }
  ...
  "min" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    CGenerator("min(x,y)<=x".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fminl(params.x, params.y))<=(params.x)")
  }
  ...
  "max" should "compile" in {
    val paramDecls =
      """long double x;
        |  long double y;""".stripMargin
    CGenerator("max(x,y)>=x".asFormula) shouldBe expectedMonitor(paramDecls, "", "(fmaxl(params.x, params.y))>=(params.x)")
  }
  ...
  "robix" should "generate C code for passivesafety" in {
    ...
    CGenerator(monitorExp, List(Variable("a"),Variable("w"),Variable("r"),Variable("xo"),Variable("yo"),
  ...
  it should "generate C code for passivesafety_renamed" in {
    ...
    val stateDecls =
      """long double a;
        ...
        |  long double xo;
        |  long double yo;""".stripMargin
    CGenerator(monitorExp, List(Variable("a"),Variable("om"),Variable("r"),Variable("xo"),Variable("yo"),
      Variable("dxo"),Variable("dyo"),Variable("t"))) shouldBe expectedMonitor(paramDecls, stateDecls,
  ...
  it should "generate C code for passivesafetyabs" in {
    ...
    val stateDecls =
      """long double a;
        ...
        |  long double y;
        |  long double yo;""".stripMargin
    CGenerator(monitorExp, vars) shouldBe expectedMonitor(paramDecls, stateDecls, "(((((curr.dxo)*(curr.dxo))) + (((curr.dyo)*(curr.dyo))))<=(((params.V)*(params.V))))&&((((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(pre.xo))&&((curr.yo)==(pre.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==(pre.w)))&&((curr.a)==(-(params.B))))&&((curr.r)==(pre.r)))&&((curr.t)==((0)))))||((((pre.v)==((0)))&&(((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(pre.xo))&&((curr.yo)==(pre.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==((0))))&&((curr.a)==((0))))&&((curr.r)==(pre.r)))&&((curr.t)==((0))))))||((((-(params.B))<=(curr.a))&&((curr.a)<=(params.A)))&&(((curr.r)!=((0)))&&((((curr.w)*(curr.r))==(pre.v))&&((((fabsl((pre.x) - (curr.xo)))>((((((pre.v)*(pre.v)))/(((2))*(params.B))) + (((params.V)*(pre.v))/(params.B))) + ((((params.A)/(params.B)) + ((1)))*((((params.A)/((2)))*(((params.ep)*(params.ep)))) + ((params.ep)*((pre.v) + (params.V)))))))||((fabsl((pre.y) - (curr.yo)))>((((((pre.v)*(pre.v)))/(((2))*(params.B))) + (((params.V)*(pre.v))/(params.B))) + ((((params.A)/(params.B)) + ((1)))*((((params.A)/((2)))*(((params.ep)*(params.ep)))) + ((params.ep)*((pre.v) + (params.V))))))))&&(((((0))<=(params.ep))&&((pre.v)>=((0))))&&((((((((((((((curr.xo)==(curr.xo))&&((curr.yo)==(curr.yo)))&&((curr.dxo)==(curr.dxo)))&&((curr.dyo)==(curr.dyo)))&&((curr.x)==(pre.x)))&&((curr.y)==(pre.y)))&&((curr.dx)==(pre.dx)))&&((curr.dy)==(pre.dy)))&&((curr.v)==(pre.v)))&&((curr.w)==(curr.w)))&&((curr.a)==(curr.a)))&&((curr.r)==(curr.r)))&&((curr.t)==((0)))))))))))")
  }
  ...
  "Compiled controller monitor" should "evaluate correctly" in {
    ...
    val code =
      s"""
        ...
        |$monitorCode
        |
        |state ctrl(state curr, parameters params) { printf("Controller chooses A\\n"); curr.a = params.A; return curr; }
        |state fallback(state curr, parameters params) { printf("Fallback returns -B\\n"); curr.a = -params.B; return curr; }
        |
        |int main() {
        ...
        |  printf("Returned a=%1.1Lf\\n", monitoredCtrl(current, params, &ctrl, &fallback).a);
        ...
        |  printf("Returned a=%1.1Lf", monitoredCtrl(next, params, &ctrl, &fallback).a);
        |  return 0;
        |}
        |""".stripMargin
