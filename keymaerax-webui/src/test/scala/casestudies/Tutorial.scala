...
class Tutorial extends FlatSpec with Matchers with BeforeAndAfterEach {
  ...
  "Example 1" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example1.key")
  ...
  "Example 1a" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example1a.key")
    val s = parseToSequent(file)
  ...
  "Example 2" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example2.key")
    val s = parseToSequent(file)
  ...
  ignore /*"Example 3a"*/ should "Example 3a be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example3a.key")
    val s = parseToSequent(file)
  ...
  ignore /*"Example 4a"*/ should "Example 4a be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example4a.key")
    val s = parseToSequent(file)
  ...
  ignore /*"Example 4b"*/ should "Example 4b be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example4b.key")
    val s = parseToSequent(file)
  ...
  ignore /*"Example 4c"*/ should "Example 4c be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example4c.key")
    val s = parseToSequent(file)
  ...
  "Example 5 with simple control" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example5_simplectrl.key")
    val s = parseToSequent(file)
  ...
  "Example 5" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example5.key")
    val s = parseToSequent(file)
  ...
  "Example 6" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example6.key")
    val s = parseToSequent(file)
  ...
  "Example 7" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example7.key")
    val s = parseToSequent(file)
  ...
  "Example 9a" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example9a.key")
    val s = parseToSequent(file)
  ...
  "Example 9b" should "be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example9b.key")
    val s = parseToSequent(file)
  ...
  ignore /* "Example 10"*/ should "Example 10 be provable" in {
    val file = this.getClass.getResourceAsStream("/examples/tutorials/sttt/example10.key")
    val s = parseToSequent(file)
