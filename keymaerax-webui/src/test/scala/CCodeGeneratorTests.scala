...
import edu.cmu.cs.ls.keymaerax.codegen.{CGenerator, CodeGenerationException}
...
//    afterEach()
    ...
    val inputFileName = "keymaerax-webui/src/test/resources/examples/casestudies/robix/passivesafetyabs.mx"
    val outputFileName = File.createTempFile("passivesafetyabs", ".c").getAbsolutePath

    KeYmaeraX.main(Array("-codegen", inputFileName, "-format", "C", "-vars", "a,w,r,xo,yo,dxo,dyo", "-nointerval", "-out", outputFileName))
