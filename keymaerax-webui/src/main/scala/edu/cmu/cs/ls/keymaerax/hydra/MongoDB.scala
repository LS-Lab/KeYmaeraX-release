...
import edu.cmu.cs.ls.keymaerax.hydra.DispatchedTacticStatus
...
object MongoDB extends DBAbstraction {
  ...
  //Collections.
  val config  = mongoClient("keymaerax")("config")
  val users   = mongoClient("keymaerax")("users")
  val models  = mongoClient("keymaerax")("models")
  val proofs  = mongoClient("keymaerax")("proofs")
  val logs    = mongoClient("keymaerax")("logs")
  val tactics = mongoClient("keymaerax")("tactics")
  val dispatchedTactics = mongoClient("keymaerax")("dispatchedTactics")
  val dispatchedCLTerms = mongoClient("keymaerax")("dispatchedCLTerms")
