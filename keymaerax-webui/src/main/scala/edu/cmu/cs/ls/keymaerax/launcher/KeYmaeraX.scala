...
object KeYmaeraX {
  ...
  private val license: String =
    """
      ...
      |
      |BY CLICKING THE "I Agree" BUTTON OR BY USING THE SOFTWARE, YOU ARE
      |AGREEING TO THE TERMS OF THIS LICENSE AGREEMENT. IF YOU DO NOT
      |AGREE WITH THESE TERMS, YOU MUST CLICK "Reject" AND YOU MAY NOT
      |USE OR DOWNLOAD THE SOFTWARE.
      |
      |This is a license agreement ("Agreement") between your academic
      |institution or non-profit organization or self (called "Licensee"
      |or "You" in this Agreement) and Carnegie Mellon University (called
      |"Licensor" in this Agreement). All rights not specifically granted
      |to you in this Agreement are reserved for Licensor.
      |
      |RESERVATION OF OWNERSHIP AND GRANT OF LICENSE: Licensor retains
      |exclusive ownership of any copy of the Software (as defined below)
      |licensed under this Agreement and hereby grants to Licensee a
      |personal, non-exclusive, non-transferable license to use the
      |Software for noncommercial research purposes, without the right to
      |sublicense, pursuant to the terms and conditions of this
      |Agreement. As used in this Agreement, the term "Software" means
      |(i) the executable file made accessible to Licensee by Licensor
      |pursuant to this Agreement, inclusive of backups, and updates
      |permitted hereunder or subsequently supplied by Licensor,
      |including all or any file structures, programming instructions,
      |user interfaces and screen formats and sequences as well as any
      |and all documentation and instructions related to it.
      |
      |CONFIDENTIALITY: Licensee acknowledges that the Software is
      |proprietary to Licensor, and as such, Licensee agrees to receive
      |all such materials in confidence and use the Software only in
      |accordance with the terms of this Agreement. Licensee agrees to
      |use reasonable effort to protect the Software from unauthorized
      ...
      |and/or conventions.
      |
      |PERMITTED USES: The Software may be used for your own
      |noncommercial internal research purposes. You understand and agree
      |that Licensor is not obligated to implement any suggestions and/or
      |feedback you might provide regarding the Software, but to the
      |extent Licensor does so, you are not entitled to any compensation
      |related thereto.
      |
      |BACKUPS: If Licensee is an organization, it may make that number
      |of copies of the Software necessary for internal noncommercial use
      |at a single site within its organization provided that all
      |information appearing in or on the original labels, including the
      |copyright and trademark notices are copied onto the labels of the
      |copies.
      |
      |USES NOT PERMITTED: You may not modify, translate, reverse
      |engineer, decompile, disassemble, distribute, copy or use the
      |Software except as explicitly permitted herein. Licensee has not
      |been granted any trademark license as part of this Agreement and
      |may not use the name or mark "KeYmaera X", "Carnegie Mellon" or
      |any renditions thereof without the prior written permission of
      |Licensor.
      |
      ...
      |Licensee's acceptance of this Agreement by clicking "I Agree"
      |below or by using the Software until terminated as provided below.
      |
      |The Agreement automatically terminates without notice if you fail
      |to comply with any provision of this Agreement. Licensee may
      |terminate this Agreement by ceasing using the Software. Upon any
      |termination of this Agreement, Licensee will delete any and all
      |copies of the Software. You agree that all provisions which
      |operate to protect the proprietary rights of Licensor shall remain
      |in force should breach occur and that the obligation of
      |confidentiality described in this Agreement is binding in
      |perpetuity and, as such, survives the term of the Agreement.
      |
      |FEE: Provided Licensee abides completely by the terms and
      |conditions of this Agreement, there is no fee due to Licensor for
      ...
      |
      |EXCLUSIVE REMEDY AND LIMITATION OF LIABILITY: To the maximum
      |extent permitted under applicable law, Licensor shall not be
      |liable for direct, indirect, special, incidental, or consequential
      |damages or lost profits related to Licensee's use of and/or
      |inability to use the Software, even if Licensor is advised of the
      |possibility of such damage.
      |
      |EXPORT REGULATION: Licensee agrees to comply with any and all
      |applicable U.S. export control laws, regulations, and/or other
      |laws related to embargoes and sanction programs administered by
      |the Office of Foreign Assets Control.
      |
      |SEVERABILITY: If any provision(s) of this Agreement shall be held
      ...
      |
      |NO IMPLIED WAIVERS: No failure or delay by Licensor in enforcing
      ...
      |without reference to conflict of laws principles. You consent to
      |the personal jurisdiction of the courts of this County and waive
      |their rights to venue outside of Allegheny County, Pennsylvania.
      |
      |ENTIRE AGREEMENT AND AMENDMENTS: This Agreement constitutes the
      |sole and entire agreement between Licensee and Licensor as to the
      |matter set forth herein and supersedes any previous agreements,
      |understandings, and arrangements between the parties relating
      |hereto.
      |
    """.stripMargin
}
