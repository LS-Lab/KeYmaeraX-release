...
object Tools {
  ...
  val toolStatus: Route = path("tools" / "vitalSigns") {
    pathEnd {
      get {
        completeRequest(new ToolStatusRequest(database, edu.cmu.cs.ls.keymaerax.Configuration(edu.cmu.cs.ls.keymaerax.Configuration.Keys.QE_TOOL)), EmptyToken())
      }
    }
  }
  ...
  val restartTool: Route = path("tools" / "restart") {
    pathEnd {
      get {
        completeRequest(new RestartToolRequest(database, edu.cmu.cs.ls.keymaerax.Configuration(edu.cmu.cs.ls.keymaerax.Configuration.Keys.QE_TOOL)), EmptyToken())
      }
    }
  }
  ...
  val testToolConnection: Route = path("tools" / "testConnection") {
    pathEnd {
      get {
        completeRequest(new TestToolConnectionRequest(database, edu.cmu.cs.ls.keymaerax.Configuration(edu.cmu.cs.ls.keymaerax.Configuration.Keys.QE_TOOL)), EmptyToken())
      }
    }
  }
