...
import org.keymaerax.hydra.responses.models.ListExamplesResponse
import org.keymaerax.hydra.{DBAbstraction, ErrorResponse, ExamplePOJO, ReadRequest, Response, UserRequest}
  ...
  override def resultingResponse(): Response = {
    ...
    val examples = List(
      ExamplePOJO(
        ...
        "/examples/implicitdefinitions.png",
        1,
      ),
      ExamplePOJO(
        6,
        ...
        "/examples/tutorials/lfcps-examples.png",
        0,
      ),
      ExamplePOJO(
        7,
