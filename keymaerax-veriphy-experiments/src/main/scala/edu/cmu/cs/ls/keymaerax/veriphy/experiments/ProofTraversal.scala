...
object ProofTraversal {
  ...
  trait TraversalFunction {
    ...
    def preS(kc: KaisarContext, kce: KaisarContext, s: Statement): Option[Statement] = None
    /* post-modify statement */
    def postS(kc: KaisarContext, kce: KaisarContext, s: Statement): Statement = s
    /* pre-modify ODE domain statement */
    def preDomS(kc: KaisarContext, kce: KaisarContext, s: DomainStatement): Option[DomainStatement] = None
    /* post-modify ODE domain statement */
    def postDomS(kc: KaisarContext, kce: KaisarContext, s: DomainStatement):  DomainStatement = s
    /* pre-modify ODE differential statement */
    def preDiffS(kc: KaisarContext, kce: KaisarContext, s: DiffStatement): Option[DiffStatement] = None
    /* post-modify ODE differential statement */
    def postDiffS(kc: KaisarContext, kce: KaisarContext, s: DiffStatement): DiffStatement = s
    /* pre-modify fact selector for proof step */
    def preSel(kc: KaisarContext, kce: KaisarContext, s: Selector): Option[Selector] = None
    /* post-modify fact selector for proof step */
    def postSel(kc: KaisarContext, kce: KaisarContext, s: Selector): Selector  = s
    /* pre-modify proof step method */
    def preM(kc: KaisarContext, kce: KaisarContext, s: Method): Option[Method] = None
    /* post-modify proof step method */
    def postM(kc: KaisarContext, kce: KaisarContext, s: Method): Method = s
    /* pre-modify forward proof term */
    def prePT(kc: KaisarContext, kce: KaisarContext, s: KaisarProofTerm): Option[KaisarProofTerm] = None
    /* post-modify forward proof term */
    def postPT(kc: KaisarContext, kce: KaisarContext, s: KaisarProofTerm): KaisarProofTerm = s
  ...
  /* Traverse statement */
  def traverse(kc: KaisarContext, kce: KaisarContext, s: Statement, tf: TraversalFunction): Statement = {
      ...
      case None =>
        val mid =
          s match {
            ...
            case Block(ss) =>
              val (conFinal, revSS) = ss.foldLeft[((KaisarContext, KaisarContext), List[Statement])]((kc, kce), List()){case (((con, cone), acc), s) =>
            ...
            case _: Modify | _: PrintGoal | _: Assume | _: Label | _: LetSym | _: Match | _: Triv | _: Pragma => s
          }
  ...
  def traverse(kc: KaisarContext, kce: KaisarContext, ds: DiffStatement, tf: TraversalFunction): DiffStatement = {
  ...
  def traverse(kc: KaisarContext, kce: KaisarContext, ds: DomainStatement, tf: TraversalFunction): DomainStatement = {
  ...
  def traverse(kc: KaisarContext, kce: KaisarContext, pt: KaisarProofTerm, tf: TraversalFunction): KaisarProofTerm = {
  ...
  def traverse(kc: KaisarContext, kce: KaisarContext, m: Method, tf: TraversalFunction): Method = {
  ...
  def traverse(kc: KaisarContext, kce: KaisarContext, s: Selector, tf: TraversalFunction): Selector = {
