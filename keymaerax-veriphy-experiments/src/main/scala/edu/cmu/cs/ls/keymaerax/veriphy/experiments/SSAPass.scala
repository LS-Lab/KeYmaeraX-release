...
import KaisarProof.{Ident, LabelDef, LabelRef, TransformationException}
import Snapshot._
import edu.cmu.cs.ls.keymaerax.core._//{Variable, _}
import edu.cmu.cs.ls.keymaerax.infrastruct._//{Variable, _}
import ASTNode._
...
object SSAPass {
  ...
  def ssa(pt: KaisarProofTerm, snapshot: Snapshot): KaisarProofTerm = {
    val node =
      pt match {
