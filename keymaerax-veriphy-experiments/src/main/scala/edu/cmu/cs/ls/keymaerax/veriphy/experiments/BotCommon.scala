...
//  val angelSandbox1DOriginMap: String = "3|->STest[4](true)\n5|->STest[6](true)\n7|->STest[8](true)\n9|->STest[10](true)\n17|->STest[18](true)\n19|->STest[20](true)\n29|->SCompose[29](STest[27](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[22](t_3),SAssignAny[23](d_2),SAssignAny[24](t_3),STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[25](d_2',-v_2),SAssign[26](t_3',1))\n31|->STest[32](true)\n33|->STest[34](true)\n35|->STest[36](true)\n37|->STest[38](true)\n57|->ASwitch[56]((d_1>=eps_0*V_0&0<=vCand_2&vCand_2<=V_0, SAssign[13](v_2,vCand_2)),(true, SAssign[14](v_2,0)))"
  // before ID mapper
  //"SCompose(SAssignAny(vCand_0),SAssignAny(eps_0),SAssignAny(v_0),SAssignAny(d_0),SAssignAny(V_0),SAssignAny(t_0),SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(vCand_1,vCand_0),SAssign(d_1,d_0)),SLoop(SCompose(SAssignAny(vCand_2),SChoice(SCompose(STest(d_1>=eps_0*V_0&0<=vCand_2&vCand_2<=V_0),SAssign(v_2,vCand_2)),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(vCand_1,vCand_2),SAssign(d_1,d_2))))))"
  ...
  //"0|->STest(true)\n1|->STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0)\n2|->STest(true)\n3|->SAssign(t_1,t_0)\n4|->STest(true)\n5|->SAssign(v_1,v_0)\n6|->STest(true)\n7|->SAssign(d_1,d_0)\n8|->STest(true)\n9|->SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0))\n10|->SAssign(v_2,V_0)\n11|->STest(0<=v_2&v_2<=V_0)\n12|->SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))\n13|->SAssign(v_2,0)\n14|->ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0)))\n15|->SAssign(t_2,0)\n16|->SAssign(t_3,t_2)\n17|->STest(true)\n18|->SAssign(d_2,d_1)\n19|->STest(true)\n20|->SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1))\n21|->SAssignAny(t_3)\n22|->SAssignAny(d_2)\n23|->SAssignAny(t_3)\n24|->SAssign(d_2',-v_2)\n25|->SAssign(t_3',1)\n26|->STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n27|->STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n28|->SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1))\n29|->STest(true)\n30|->SAssign(t_1,t_3)\n31|->STest(true)\n32|->SAssign(v_1,v_2)\n33|->STest(true)\n34|->SAssign(d_1,d_2)\n35|->STest(true)\n36|->SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))\n37|->SCompose(ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0))),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2)))\n38|->SLoop(SCompose(ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0))),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))\n39|->STest(true)\n40|->SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0)),SLoop(SCompose(ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0))),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2)))))\n41|->SAssignAny(eps_0)\n42|->SAssignAny(v_0)\n43|->SAssignAny(d_0)\n44|->SAssignAny(V_0)\n45|->SAssignAny(t_0)\n46|->SCompose(SAssignAny(eps_0),SAssignAny(v_0),SAssignAny(d_0),SAssignAny(V_0),SAssignAny(t_0),SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0)),SLoop(SCompose(ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0))),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))))\n47|->SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0))\n48|->STest(d_1>=eps_0*V_0)\n49|->SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))\n50|->SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0)))\n51|->STest(true)\n52|->ASwitch((true, SAssign(v_2,0)))\n53|->ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0)))\n54|->SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0))\n55|->SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1))\n56|->SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1))\n57|->SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))\n58|->SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2)))\n59|->SLoop(SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))\n60|->SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0)),SLoop(SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2)))))\n61|->SCompose(SAssignAny(eps_0),SAssignAny(v_0),SAssignAny(d_0),SAssignAny(V_0),SAssignAny(t_0),SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(d_1,d_0)),SLoop(SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))))"
  ...
  //"3|->STest(true)\n5|->STest(true)\n7|->STest(true)\n16|->STest(true)\n18|->STest(true)\n28|->SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1))\n30|->STest(true)\n32|->STest(true)\n34|->STest(true)\n54|->ASwitch((d_1>=eps_0*V_0, SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),(true, SAssign(v_2,0)))"
  ...
  // before aforloop
  //val timedAngelControl1DStratString: String = "SCompose[68](SAssignAny[43](eps_0),SAssignAny[44](v_0),SAssignAny[45](d_0),SAssignAny[46](time_0),SAssignAny[47](V_0),SAssignAny[48](t_0),SCompose[67](STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose[50](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0)),SCompose[66](SLoop[64](SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))),STest[65](!time_1<=10000))))"
  //val timedAngelControl1DIDMap: String = "0|->STest[0](true)\n1|->STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0)\n2|->STest[2](true)\n3|->SAssign[3](t_1,t_0)\n4|->STest[4](true)\n5|->SAssign[5](v_1,v_0)\n6|->STest[6](true)\n7|->SAssign[7](time_1,time_0)\n8|->STest[8](true)\n9|->SAssign[9](d_1,d_0)\n10|->STest[10](true)\n11|->SCompose[11](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0))\n12|->SAssign[12](v_2,V_0)\n13|->STest[13](0<=v_2&v_2<=V_0)\n14|->SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))\n15|->SAssign[15](v_2,0)\n16|->ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0)))\n17|->SAssign[17](t_2,0)\n18|->SAssign[18](t_3,t_2)\n19|->STest[19](true)\n20|->SAssign[20](d_2,d_1)\n21|->STest[21](true)\n22|->SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1))\n23|->SAssignAny[23](t_3)\n24|->SAssignAny[24](d_2)\n25|->SAssignAny[25](t_3)\n26|->SAssign[26](d_2',-v_2)\n27|->SAssign[27](t_3',1)\n28|->STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n29|->STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n30|->SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1))\n31|->STest[31](true)\n32|->SAssign[32](t_1,t_3)\n33|->STest[33](true)\n34|->SAssign[34](v_1,v_2)\n35|->STest[35](true)\n36|->SAssign[36](d_1,d_2)\n37|->STest[37](true)\n38|->SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))\n39|->SCompose[39](ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0))),SAssign[17](t_2,0),SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2)))\n40|->ALoop[40](time_1<=10000,SCompose[39](ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0))),SAssign[17](t_2,0),SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))\n41|->STest[41](true)\n42|->SCompose[42](STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose[11](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0)),ALoop[40](time_1<=10000,SCompose[39](ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0))),SAssign[17](t_2,0),SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2)))))\n43|->SAssignAny[43](eps_0)\n44|->SAssignAny[44](v_0)\n45|->SAssignAny[45](d_0)\n46|->SAssignAny[46](time_0)\n47|->SAssignAny[47](V_0)\n48|->SAssignAny[48](t_0)\n49|->SCompose[49](SAssignAny[43](eps_0),SAssignAny[44](v_0),SAssignAny[45](d_0),SAssignAny[46](time_0),SAssignAny[47](V_0),SAssignAny[48](t_0),SCompose[42](STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose[11](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0)),ALoop[40](time_1<=10000,SCompose[39](ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0))),SAssign[17](t_2,0),SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))))\n50|->SCompose[50](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0))\n51|->STest[51](time_1<=10000)\n52|->STest[52](d_1>=eps_0*V_0)\n53|->SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))\n54|->SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0)))\n55|->STest[55](true)\n56|->ASwitch[56]((true, SAssign[15](v_2,0)))\n57|->ASwitch[57]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0)))\n58|->SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0))\n59|->SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1))\n60|->SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1))\n61|->SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))\n62|->SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2)))\n63|->SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))\n64|->SLoop[64](SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2)))))\n65|->STest[65](!time_1<=10000)\n66|->SCompose[66](SLoop[64](SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))),STest[65](!time_1<=10000))\n67|->SCompose[67](STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose[50](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0)),SCompose[66](SLoop[64](SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))),STest[65](!time_1<=10000)))\n68|->SCompose[68](SAssignAny[43](eps_0),SAssignAny[44](v_0),SAssignAny[45](d_0),SAssignAny[46](time_0),SAssignAny[47](V_0),SAssignAny[48](t_0),SCompose[67](STest[1](d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose[50](SAssign[3](t_1,t_0),SAssign[5](v_1,v_0),SAssign[7](time_1,time_0),SAssign[9](d_1,d_0)),SCompose[66](SLoop[64](SCompose[63](STest[51](time_1<=10000),SCompose[62](SChoice[58](SCompose[54](STest[52](d_1>=eps_0*V_0),SCompose[53](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[15](v_2,0)),SAssign[17](t_2,0),SCompose[59](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[60](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[61](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))),STest[65](!time_1<=10000))))"
  //val timedAngelControl1DOriginMap: String = "3|->STest[4](true)\n5|->STest[6](true)\n7|->STest[8](true)\n9|->STest[10](true)\n18|->STest[19](true)\n20|->STest[21](true)\n30|->SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1))\n32|->STest[33](true)\n34|->STest[35](true)\n36|->STest[37](true)\n58|->ASwitch[57]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0)))\n64|->ALoop[40](time_1<=10000,SCompose[39](ASwitch[16]((d_1>=eps_0*V_0, SCompose[14](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[15](v_2,0))),SAssign[17](t_2,0),SCompose[22](SAssign[18](t_3,t_2),SAssign[20](d_2,d_1)),SCompose[30](STest[28](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[23](t_3),SAssignAny[24](d_2),SAssignAny[25](t_3),STest[29](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[26](d_2',-v_2),SAssign[27](t_3',1)),SCompose[38](SAssign[32](t_1,t_3),SAssign[34](v_1,v_2),SAssign[36](d_1,d_2))))"

  // before name mapping
  //"SCompose(SAssignAny(eps_0),SAssignAny(v_0),SAssignAny(d_0),SAssignAny(time_0),SAssignAny(V_0),SAssignAny(t_0),SCompose(STest(d_0>=0&V_0>=0&eps_0>=0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(v_1,v_0),SAssign(time_1,time_0),SAssign(d_1,d_0)),SCompose(SLoop(SCompose(STest(time_1<=10000),SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))),STest(!time_1<=10000))))"
  ...
  // Before AForLoop conversion
  //val reachAvoid1DStratString: String = "SCompose[70](SAssignAny[45](eps_0),SAssignAny[46](pos_0),SAssignAny[47](v_0),SAssignAny[48](d_0),SAssignAny[49](V_0),SAssignAny[50](t_0),SCompose[69](STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose[52](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0)),SCompose[68](SLoop[66](SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))),STest[67](!(pos_1<=d_0&d_1>=V_0*eps_0)))))"
  //val reachAvoid1DIDMap: String = "0|->STest[0](true)\n1|->STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0)\n2|->STest[2](true)\n3|->SAssign[3](t_1,t_0)\n4|->STest[4](true)\n5|->SAssign[5](pos_1,pos_0)\n6|->STest[6](true)\n7|->SAssign[7](v_1,v_0)\n8|->STest[8](true)\n9|->SAssign[9](d_1,d_0)\n10|->STest[10](true)\n11|->SCompose[11](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0))\n12|->SAssign[12](v_2,V_0)\n13|->STest[13](0<=v_2&v_2<=V_0)\n14|->STest[14](true)\n15|->SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))\n16|->SAssign[16](v_2,0)\n17|->STest[17](true)\n18|->ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0)))\n19|->SAssign[19](t_2,0)\n20|->SAssign[20](t_3,t_2)\n21|->STest[21](true)\n22|->SAssign[22](d_2,d_1)\n23|->STest[23](true)\n24|->SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1))\n25|->SAssignAny[25](t_3)\n26|->SAssignAny[26](d_2)\n27|->SAssignAny[27](t_3)\n28|->SAssign[28](d_2',-v_2)\n29|->SAssign[29](t_3',1)\n30|->STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n31|->STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3))\n32|->SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1))\n33|->STest[33](true)\n34|->SAssign[34](t_1,t_3)\n35|->STest[35](true)\n36|->SAssign[36](v_1,v_2)\n37|->STest[37](true)\n38|->SAssign[38](d_1,d_2)\n39|->STest[39](true)\n40|->SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))\n41|->SCompose[41](ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0))),SAssign[19](t_2,0),SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2)))\n42|->ALoop[42](pos_1<=d_0&d_1>=V_0*eps_0,SCompose[41](ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0))),SAssign[19](t_2,0),SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))\n43|->STest[43](true)\n44|->SCompose[44](STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose[11](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0)),ALoop[42](pos_1<=d_0&d_1>=V_0*eps_0,SCompose[41](ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0))),SAssign[19](t_2,0),SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2)))))\n45|->SAssignAny[45](eps_0)\n46|->SAssignAny[46](pos_0)\n47|->SAssignAny[47](v_0)\n48|->SAssignAny[48](d_0)\n49|->SAssignAny[49](V_0)\n50|->SAssignAny[50](t_0)\n51|->SCompose[51](SAssignAny[45](eps_0),SAssignAny[46](pos_0),SAssignAny[47](v_0),SAssignAny[48](d_0),SAssignAny[49](V_0),SAssignAny[50](t_0),SCompose[44](STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose[11](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0)),ALoop[42](pos_1<=d_0&d_1>=V_0*eps_0,SCompose[41](ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0))),SAssign[19](t_2,0),SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))))\n52|->SCompose[52](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0))\n53|->STest[53](pos_1<=d_0&d_1>=V_0*eps_0)\n54|->STest[54](d_1>=eps_0*V_0)\n55|->SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))\n56|->SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0)))\n57|->STest[57](true)\n58|->ASwitch[58]((true, SAssign[16](v_2,0)))\n59|->ASwitch[59]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0)))\n60|->SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0))\n61|->SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1))\n62|->SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1))\n63|->SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))\n64|->SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2)))\n65|->SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))\n66|->SLoop[66](SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2)))))\n67|->STest[67](!(pos_1<=d_0&d_1>=V_0*eps_0))\n68|->SCompose[68](SLoop[66](SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))),STest[67](!(pos_1<=d_0&d_1>=V_0*eps_0)))\n69|->SCompose[69](STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose[52](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0)),SCompose[68](SLoop[66](SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))),STest[67](!(pos_1<=d_0&d_1>=V_0*eps_0))))\n70|->SCompose[70](SAssignAny[45](eps_0),SAssignAny[46](pos_0),SAssignAny[47](v_0),SAssignAny[48](d_0),SAssignAny[49](V_0),SAssignAny[50](t_0),SCompose[69](STest[1](d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose[52](SAssign[3](t_1,t_0),SAssign[5](pos_1,pos_0),SAssign[7](v_1,v_0),SAssign[9](d_1,d_0)),SCompose[68](SLoop[66](SCompose[65](STest[53](pos_1<=d_0&d_1>=V_0*eps_0),SCompose[64](SChoice[60](SCompose[56](STest[54](d_1>=eps_0*V_0),SCompose[55](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),SAssign[16](v_2,0)),SAssign[19](t_2,0),SCompose[61](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[62](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[63](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))),STest[67](!(pos_1<=d_0&d_1>=V_0*eps_0)))))"
  //val reachAvoid1DOriginMap: String = "3|->STest[4](true)\n5|->STest[6](true)\n7|->STest[8](true)\n9|->STest[10](true)\n20|->STest[21](true)\n22|->STest[23](true)\n32|->SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1))\n34|->STest[35](true)\n36|->STest[37](true)\n38|->STest[39](true)\n60|->ASwitch[59]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0)))\n66|->ALoop[42](pos_1<=d_0&d_1>=V_0*eps_0,SCompose[41](ASwitch[18]((d_1>=eps_0*V_0, SCompose[15](SAssign[12](v_2,V_0),STest[13](0<=v_2&v_2<=V_0))),(true, SAssign[16](v_2,0))),SAssign[19](t_2,0),SCompose[24](SAssign[20](t_3,t_2),SAssign[22](d_2,d_1)),SCompose[32](STest[30](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny[25](t_3),SAssignAny[26](d_2),SAssignAny[27](t_3),STest[31](t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign[28](d_2',-v_2),SAssign[29](t_3',1)),SCompose[40](SAssign[34](t_1,t_3),SAssign[36](v_1,v_2),SAssign[38](d_1,d_2))))"

  // before angelic mapping
  //"SCompose(SAssignAny(eps_0),SAssignAny(pos_0),SAssignAny(v_0),SAssignAny(d_0),SAssignAny(V_0),SAssignAny(t_0),SCompose(STest(d_0>=0&V_0>0&eps_0>0&v_0=0&t_0=0),SCompose(SAssign(t_1,t_0),SAssign(pos_1,pos_0),SAssign(v_1,v_0),SAssign(d_1,d_0)),SCompose(SLoop(SCompose(STest(pos_1<=d_0&d_1>=V_0*eps_0),SCompose(SChoice(SCompose(STest(d_1>=eps_0*V_0),SCompose(SAssign(v_2,V_0),STest(0<=v_2&v_2<=V_0))),SAssign(v_2,0)),SAssign(t_2,0),SCompose(SAssign(t_3,t_2),SAssign(d_2,d_1)),SCompose(STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssignAny(t_3),SAssignAny(d_2),SAssignAny(t_3),STest(t_3>=0&t_3<=eps_0&d_2>=v_2*(eps_0-t_3)),SAssign(d_2',-v_2),SAssign(t_3',1)),SCompose(SAssign(t_1,t_3),SAssign(v_1,v_2),SAssign(d_1,d_2))))),STest(!(pos_1<=d_0&d_1>=V_0*eps_0)))))"
