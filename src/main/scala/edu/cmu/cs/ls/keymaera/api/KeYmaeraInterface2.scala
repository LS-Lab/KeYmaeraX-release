...
/**
 * THIS IS A COPY OF THE PREVIOUS KEYMAERA INTERFACE FILE... TODO um.
 * Open issues:
 ...
 *
 * Created by Nathan and Stefan on 6/12/14.
 */
object KeYmaeraInterface2 {
   ...
   * @return um.
   */
  def addTask(content: String): (Int, ProofNode) = {
    new KeYmaeraParser().runParser(content) match {
      case f: Formula =>
        ...
        //TODO calling json for its side-effects... do this correctly.
