...
object DerivationInfo {
  ...
  def ofCodeName(codeName: String): DerivationInfo = codeName match {
    ...
    case "refSeqIdL" => DerivationInfo("refSeqIdL", List(), 1)
    ...
    case "refSeqAssoc" => DerivationInfo("refSeqAssoc", List(), 1)
    ...
    case "refTrans" => DerivationInfo("refTrans", List(ExpressionArg("c", List())), 1)
    ...
    case "refChoiceL" => DerivationInfo("refChoiceL", List(), 1)
    ...
    case "refSeq" => DerivationInfo("refSeq", List(), 1)
    ...
    case "refAnnihL" => DerivationInfo("refAnnihL", List(), 1)
    ...
    case "refChoiceAssoc" => DerivationInfo("refChoiceAssoc", List(), 1)
    case "refAssign" => DerivationInfo("refAssign", List(), 1)
    ...
    case "refAssignTest" => DerivationInfo("refAssignTest", List(), 1)
    ...
    case "refUnloop" => DerivationInfo("refUnloop", List(), 1)
    ...
    case "refAssignDet" => DerivationInfo("refAssignDet", List(), 1)
    ...
    case "refBox" => DerivationInfo("refBox", List(), 1)
    ...
    case "refTest" => DerivationInfo("refTest", List(), 1)
    ...
    case "refAnyTest" => DerivationInfo("refAnyTest", List(), 1)
    ...
    case "refDistrR" => DerivationInfo("refDistrR", List(), 1)
    ...
    case "refAssignComm" => DerivationInfo("refAssignComm", List(), 1)
    ...
    case "refChoiceId" => DerivationInfo("refChoiceId", List(), 1)
    ...
    case "refUnfoldL" => DerivationInfo("refUnfoldL", List(), 1)
    ...
    case "refRefl" => DerivationInfo("refRefl", List(), 1)
    ...
    case "refAssignSubst" => DerivationInfo("refAssignSubst", List(), 1)
    ...
    case "refDX" => DerivationInfo("refDX", List(), 1)
    ...
    case "refAnyComm" => DerivationInfo("refAnyComm", List(), 1)
    ...
    case "refChoiceIdemp" => DerivationInfo("refChoiceIdemp", List(), 1)
    ...
    case "refDE" => DerivationInfo("refDE", List(), 1)
    ...
    case "refOde" => DerivationInfo("refOde", List(), 1)
    ...
    case "refDistrL" => DerivationInfo("refDistrL", List(), 1)
    ...
    case "refOdeIdemp" => DerivationInfo("refOdeIdemp", List(), 1)
    case "refAssignAnyComm" => DerivationInfo("refAssignAnyComm", List(), 1)
    ...
    case "refDW" => DerivationInfo("refDW", List(), 1)
    ...
    case "refAnyAssignMerge" => DerivationInfo("refAnyAssignMerge", List(), 1)
    ...
    case "refChoiceComm" => DerivationInfo("refChoiceComm", List(), 1)
    ...
    case "refStutter" => DerivationInfo("refStutter", List(), 1)
    ...
    case "refAnyMerge" => DerivationInfo("refAnyMerge", List(), 1)
    ...
    case "refSeqIdR" => DerivationInfo("refSeqIdR", List(), 1)
    ...
    case "refAntiSym" => DerivationInfo("refAntiSym", List(), 1)
    ...
    case "refLoopR" => DerivationInfo("refLoopR", List(), 1)
    case "branch2Left" => DerivationInfo("branch2Left", List(), 1)
    case "refLoopL" => DerivationInfo("refLoopL", List(), 1)
    ...
    case "refChoiceR" => DerivationInfo("refChoiceR", List(), 1)
