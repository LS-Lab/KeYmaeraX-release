...
lazy val root = project
  ...
  .settings(
    ...
    Compile / unmanagedSources +=
      baseDirectory.value.getParentFile / "keymaerax-core" / "src" / "main" / "java" / "edu" / "cmu" / "cs" / "ls" / "keymaerax" / "core" / "Assertion.java",
    Compile / unmanagedSources +=
      baseDirectory.value.getParentFile / "keymaerax-core" / "src" / "main" / "scala" / "edu" / "cmu" / "cs" / "ls" / "keymaerax" / "info" / "package.scala",
    Compile / unmanagedSources +=
      baseDirectory.value.getParentFile / "keymaerax-core" / "src" / "main" / "scala" / "edu" / "cmu" / "cs" / "ls" / "keymaerax" / "info" / "VersionNumber.scala",
    Compile / unmanagedSources +=
