...
import org.keymaerax.parser.{BuiltinSymbols, Declaration, ParseException, Parser}
import fastparse.P

/**
 * Parser interface for Bellerophon tactics of KeYmaera X. Provides a parser to read string inputs as a Bellerophon
 * tactic. A parser is a function from input strings to [[org.keymaerax.bellerophon.BelleExpr Bellerophon expressions]].
 * {{{
