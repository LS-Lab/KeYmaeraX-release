...
import org.keymaerax.tools.qe.{BinaryMathOpSpec, LiteralMathOpSpec, MathematicaOpSpec, NaryMathOpSpec, UnaryMathOpSpec}
import org.keymaerax.tools.qe.MathematicaOpSpec.{int, symbol}
