...
/**
 * A collection of papers referenced in the scaladoc of KeYmaera X.
 *
...
object Bibliography {
  ...
  /**
   * Stefan Mitsch and André Platzer.
   * [[https://doi.org/10.1007/s10703-016-0241-z ModelPlex: Verified runtime validation of verified cyber-physical system models (FMSD)]].
