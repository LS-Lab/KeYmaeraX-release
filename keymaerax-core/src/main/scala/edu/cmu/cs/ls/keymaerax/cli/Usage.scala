...
import edu.cmu.cs.ls.keymaerax.info.{FullNameAndVersion, ShortCopyright}
...
object Usage {
  ...
  private val usage: String =
    s"""Usage: java -jar keymaerax.jar
       ...
       |$FullNameAndVersion
       |$ShortCopyright
       |See -copyright, -license, and -thirdPartyLicenses for more details.""".stripMargin
