 ...
 *
 * @see
 *   Sarah Loos. [[http://reports-archive.adm.cs.cmu.edu/anon/2015/CMU-CS-15-144.pdf Differential Refinement Logic]].
 *   Carnegie Mellon Technical Report CMU-CS-15-144. (Especially section 3.6.2)
 * @author
 *   Nathan Fulton
 */
