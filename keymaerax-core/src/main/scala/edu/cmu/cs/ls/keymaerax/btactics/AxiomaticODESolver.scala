...
//  private def integralOf2(v: Variable, ode: DifferentialProgram, initConds: List[Formula]): Term = {
//    val vPrime = atomicODEs(ode).find(x => x.xp.x == v).vPrime
//
//    StaticSemantics.freeVars(vPrime)
//  }
