...
object HereP extends PosInExpr
   ...
   */
  abstract class Position private[keymaerax](val index: Int, val inExpr: PosInExpr = HereP) {
...
object Position {
  ...
  class AntePosition private[ls](index: Int, inExpr: PosInExpr = HereP) extends Position(index, inExpr) {
    def isAnte = true
  ...
  class SuccPosition private[ls] (index: Int, inExpr: PosInExpr = HereP) extends Position(index, inExpr) {
    def isAnte = false
