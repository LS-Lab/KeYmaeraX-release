...
import edu.cmu.cs.ls.keymaerax.tactics.AxiomaticRuleTactics.{equivalenceCongruenceT,equationCongruenceT}
...
import edu.cmu.cs.ls.keymaerax.tactics.TacticLibrary.TacticHelper.{getFormula,getTerm}
...
object SyntacticDerivationInContext {
  ...
  def PowerDerivativeT = PowerDerivativeImpl.PowerDerivativeT
