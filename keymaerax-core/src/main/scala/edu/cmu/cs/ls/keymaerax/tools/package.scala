 ...
 *
 *    - `[[edu.cmu.cs.ls.keymaerax.tools.ext.Mathematica]]` - Mathematica interface for real arithmetic and ODE solver etc.
...
package object tools {
  ...
  def diagnostic: String =
    ...
    "\nMathematica J/Link:   " + Configuration.getString(Configuration.Keys.MATHEMATICA_JLINK_LIB_DIR).getOrElse("undefined") +
    "\nWolfram Engine J/Link:" + Configuration.getString(Configuration.Keys.WOLFRAMENGINE_JLINK_LIB_DIR).getOrElse("undefined") +
