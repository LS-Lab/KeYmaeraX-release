...
object LinearMatcher extends SchematicUnificationMatch {
  ...
  /** unifies(s1,s2, t1,t2) unifies (s1,s2) against (t1,t2) by matching.
    ...
    */
  override protected def unifies2(s1: Expression, s2: Expression, t1: Expression, t2: Expression): List[(Expression, Expression)] =
  ...
  override protected def unifiesODE2(s1: DifferentialProgram, s2: DifferentialProgram, t1: DifferentialProgram, t2: DifferentialProgram): List[(Expression, Expression)] =
