...
//      byUS(equivReflexiveAxiom)
  ...
  lazy val darbouxGt = derivedAxiom("DBX>",
    ...
    implyR(1) & implyR(1) &
      ...
      useAt(CoreAxiomInfo("exists eliminate y"), PosInExpr(1::Nil))(1) & //existsR/*(dbx_internal)*/(1) &
      ...
      cutR("[{c{|y_|},y_'=(-(g(|y_|)/2))*y_+0&q(|y_|)}]e(|y_|)*y_^2>0".asFormula)(1) <(
        useAt("DI differential invariant")(1) & implyR(1) & andR(1) <(
          DebuggingTactics.print("DI base") &
            cohide2(-2,1) & byUS(TactixLibrary.proveBy(Sequent(IndexedSeq("e()>0".asFormula), IndexedSeq("e()*y()^2>=0".asFormula)), QE & done))
          ,
        ...
        DebuggingTactics.print("DI finish") & cohide2(-1,1) & monb & DebuggingTactics.print("DI finished") & byUS(TactixLibrary.proveBy(Sequent(IndexedSeq("ep()>=g()*e()".asFormula), IndexedSeq("ep()*y()^2 + e()*(2*y()^(2-1)*((-g()/2)*y()+0))>=0".asFormula)), QE & done))
        )
        ,
        implyR(1) &
        DebuggingTactics.print("new post") & cohide2(-3, 1) & monb & byUS(TactixLibrary.proveBy(Sequent(IndexedSeq("e()*y()^2>0".asFormula), IndexedSeq("e()>0".asFormula)), QE & done))
        )
  )
