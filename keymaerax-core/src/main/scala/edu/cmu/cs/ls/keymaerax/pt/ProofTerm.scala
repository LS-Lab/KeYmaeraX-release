...
case class CTTerm(child: ProofTerm, premise: Equal, substitution: List[USubst]) extends ProofTerm
case class CQTerm(child: ProofTerm, premise: Equal, substitution: List[USubst]) extends ProofTerm
case class CETerm(child: ProofTerm, premise: Equiv, substitution: List[USubst]) extends ProofTerm
