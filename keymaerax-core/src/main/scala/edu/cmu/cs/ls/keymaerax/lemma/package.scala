 ...
 *
 * ===Lemma Mechanism===
 * An implementation of a lemma data base using files [[edu.cmu.cs.ls.keymaerax.lemma.FileLemmaDB]]. A factory
 * [[edu.cmu.cs.ls.keymaerax.lemma.LemmaDBFactory]] provides instances of lemma databases.
 *
 * @example
 *   {{{
 *   // prove a lemma
