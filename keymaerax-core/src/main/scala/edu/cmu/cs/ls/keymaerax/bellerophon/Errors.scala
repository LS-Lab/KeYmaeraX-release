 ...
 * raised when trying to apply [[edu.cmu.cs.ls.keymaerax.btactics.SequentCalculus.andR]] at the correct position 2 in
 * bounds on the right-hand side where it turns out there is an Or formula not an And formula. This does not indicate a
 ...
 * its [[edu.cmu.cs.ls.keymaerax.btactics.macros.AxiomInfo]].
 */
