...
/* @note soundness requires no primes in f(||) which follows from data structure invariant */
...
/* @note compared to J. ACM, the following axiom
  ...
  @note soundness requires no primes in f(|t_|) which follows from data structure invariant*/
