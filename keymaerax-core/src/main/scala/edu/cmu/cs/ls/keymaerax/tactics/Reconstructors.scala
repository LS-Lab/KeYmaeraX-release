...
object Reconstructors {
  ...
  def reconstruct(e: UnaryCompositeTerm): Term=>Term = {e match {
  ...
  def reconstruct(e: BinaryCompositeTerm): (Term,Term)=>Term = {e match {
    case _: Plus   => Plus.apply
    case _: Minus  => Minus.apply
  ...
  def reconstruct(e: UnaryCompositeFormula): Formula=>Formula = {e match {
    case _: Not => Not.apply
  }
  }

  /** Reconstructor for binary formulas of type e */
  def reconstruct(e: BinaryCompositeFormula): (Formula,Formula)=>Formula = {e match {
  ...
  def reconstruct(e: ComparisonFormula): (Term,Term)=>Formula = {e match {
  ...
  def reconstruct(e: Quantified): (Seq[Variable],Formula)=>Formula = {e match {
  ...
  def reconstruct(e: Modal): (Program,Formula)=>Formula = {e match {
  ...
  def reconstruct(e: UnaryCompositeProgram): Program=>Program = {e match {
  ...
  def reconstruct(e: BinaryCompositeProgram): (Program,Program)=>Program = {e match {
