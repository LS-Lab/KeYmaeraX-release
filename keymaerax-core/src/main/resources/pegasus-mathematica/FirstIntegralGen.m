...
(* Boreale method for computing Darboux polynomials *)
FindDbxBoreale[pre_List,deg_Integer?NonNegative,vars_List,vectorField_List]:=Module[{
preGB,MonBas,TemplateCoeffs,DbxTemplate,LieDTemplate,rem,problem,sol,Dbxs,
(* Maximum total polynomial degree of the first integral being sought *)
r=deg, 
(* Maximum total polynomial degree of the vector field *)
d=Max[Map[PolynomDegree,vectorField]]},
