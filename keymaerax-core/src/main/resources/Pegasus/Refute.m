...
Cond1 = Q && A && Not[B],
Cond2 = Q && A && LZZ`InfS[Q,f,vars,Q]&& Not[LZZ`InfS[B,f,vars,Q]],
Cond3 = Q && Not[B] && LZZ`IvInfS[Q,f,vars,Q] && LZZ`IvInfS[A,f,vars,Q]
},
...
(* B \[Rule] [x'=f(x)&Q] B *)
(* B,Q,Q* \[Rule] B* *)
Condi1 = Implies[B && Q && LZZ`InfS[Q,f,vars,Q] , LZZ`InfS[B,f,vars,Q]],
(* ~B,Q,Q-* \[Rule] ~B-* *)
Condi2 = Implies[Not[B] && Q && LZZ`IvInfS[Q,f,vars,Q] , Not[LZZ`IvInfS[B,f,vars,Q]]],
(* A \[Rule] [x'=f(x)&Q] B *)
(* Q, A \[Rule] B *)
Condn1 = Implies[Q && A , B],
(* Q,A,Q* \[Rule] B* *)
Condn2 = Implies[A && Q && LZZ`InfS[Q,f,vars,Q], LZZ`InfS[B,f,vars,Q]],
(* Q,~B,Q-* \[Rule] ~A* *)
Condn3 = Implies[Not[B] && Q && LZZ`IvInfS[Q,f,vars,Q], Not[LZZ`IvInfS[A,f,vars,Q]]]
},
